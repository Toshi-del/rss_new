...
@section('page-title', 'Create Medical Test Category')
            ...
            <form action="{{ route('admin.medical-test-categories.store') }}" method="POST" class="p-8 space-y-8">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-150 @error('name') border-red-500 ring-2 ring-red-200 @enderror" 
                           required>
                    @error('name')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" 
                               ...
                               min="0"
                               placeholder="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-150 @error('sort_order') border-red-500 ring-2 ring-red-200 @enderror">
