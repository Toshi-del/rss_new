...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <form action="{{ route('inventory.store') }}" method="POST" class="space-y-6 p-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="number" name="item_quantity" id="item_quantity" value="{{ old('item_quantity', 0) }}" min="0"
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">
                                <strong>Note:</strong> The status will be automatically set based on the quantity. Items with quantity greater than 0 will be marked as "In Stock", while items with 0 quantity will be marked as "Out of Stock".
                            </p>
                        </div>
                    </div>
                </div>
