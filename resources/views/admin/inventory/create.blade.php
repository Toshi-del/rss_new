            ...
            <form action="{{ route('admin.inventory.store') }}" method="POST" class="p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="item_status" 
                                ...
                                required>
                            <option value="active" {{ old('item_status', 'active') == 'active' ? 'selected' : '' }}>Active</option>
                            <option value="inactive" {{ old('item_status') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                            <option value="out_of_stock" {{ old('item_status') == 'out_of_stock' ? 'selected' : '' }}>Out of Stock</option>
                        </select>
                        @error('item_status')
                            <div class="flex items-center space-x-2 mt-2">
                                <i class="fas fa-exclamation-circle text-red-500 text-sm"></i>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" 
                              ...
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-150 resize-none @error('description') border-red-500 ring-2 ring-red-200 @enderror">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="flex items-center space-x-2 mt-2">
                            <i class="fas fa-exclamation-circle text-red-500 text-sm"></i>
                            <p class="text-sm text-red-600">{{ $message }}</p>
