...
@section('title', 'Add Inventory Item - RSS Citi Health Services')
    ...
    <div class="bg-blue-600 px-6 py-4">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h3 class="text-lg font-bold text-white">Add New Inventory Item</h3>
                    <p class="text-blue-100 text-sm">Create a new medical supply or equipment entry</p>
                </div>
            </div>
...
<div class="content-card rounded-xl shadow-lg border border-gray-200">
    <form action="{{ route('admin.inventory.store') }}" method="POST" class="p-8">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('name') }}"
                           required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('name') border-red-300 @enderror"
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           name="sku" 
                           value="{{ old('sku') }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('sku') border-red-300 @enderror"
                           placeholder="Auto-generated if empty">
                    @error('sku')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <p class="mt-1 text-xs text-gray-500">Leave empty to auto-generate a unique SKU</p>
                </div>
            </div>
            ...
            <div class="mt-6">
                ...
                <textarea id="description" 
                          name="description" 
                          rows="3"
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('description') border-red-300 @enderror"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select id="category" 
                            name="category" 
                            required
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('category') border-red-300 @enderror">
                ...
                <div>
                    ...
                    <select id="unit" 
                            name="unit" 
                            required
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('unit') border-red-300 @enderror">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="number" 
                           ...
                           min="0"
                           required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('current_quantity') border-red-300 @enderror"
                           placeholder="0">
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           min="0"
                           required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('minimum_quantity') border-red-300 @enderror"
                           placeholder="0">
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           min="0"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('maximum_quantity') border-red-300 @enderror"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" 
                           ...
                           step="0.01"
                           required
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('unit_cost') border-red-300 @enderror"
                           placeholder="0.00">
                    @error('unit_cost')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select id="status" 
                            name="status" 
                            required
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('status') border-red-300 @enderror">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" 
                           ...
                           name="supplier" 
                           value="{{ old('supplier') }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('supplier') border-red-300 @enderror"
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           name="location" 
                           value="{{ old('location') }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('location') border-red-300 @enderror"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="date" 
                           ...
                           min="{{ date('Y-m-d') }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('expiry_date') border-red-300 @enderror">
                    @error('expiry_date')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <textarea id="notes" 
                              name="notes" 
                              rows="3"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm @error('notes') border-red-300 @enderror"
        ...
        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
            ...
            <button type="submit" 
                    class="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all duration-150 shadow-md flex items-center space-x-2">
