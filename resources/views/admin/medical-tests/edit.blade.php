...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Edit Medical Test</h1>
        </div>

        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <form action="{{ route('medical-tests.update', $medicalTest) }}" method="POST" class="space-y-6 p-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $medicalTest->name) }}" 
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3" 
                              class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $medicalTest->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price', $medicalTest->price) }}" 
                               step="0.01" min="0" 
                ...
                <div>
                    ...
                    <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $medicalTest->sort_order) }}" min="0"
                ...
                <div class="flex items-center">
                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $medicalTest->is_active) ? 'checked' : '' }}
