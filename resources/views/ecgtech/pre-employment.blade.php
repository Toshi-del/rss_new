        ...
        <table class="w-full" id="recordsTable">
            ...
            <tbody class="bg-white divide-y divide-gray-100">
                @forelse($preEmployments as $preEmployment)
                    <tr class="hover:bg-gray-50 transition-colors duration-200 record-row" data-name="{{ strtolower($preEmployment->first_name . ' ' . $preEmployment->last_name) }}" data-company="{{ strtolower($preEmployment->company_name) }}" data-status="{{ $preEmployment->status }}">
