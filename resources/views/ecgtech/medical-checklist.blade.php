...
<div class="max-w-4xl mx-auto py-8">
    <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
        <div class="bg-ecgtech-900 text-white text-center py-3 rounded-t-lg mb-8">
        ...
        @endif
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                @if($field === 'ecg')
                                    ...
                                    <input type="text" name="{{ $field }}_done_by" 
                                           ...
                                           placeholder="ECG Tech Name" 
                                           class="form-input w-40 rounded border-gray-300 text-sm focus:ring-ecgtech-500 focus:border-ecgtech-500"
                                           required>
                                @else
                                    ...
                                    <input type="text" name="{{ $field }}_done_by" 
                                           ...
                                           class="form-input w-40 rounded border-gray-300 text-sm bg-gray-100 text-gray-500" 
                                           readonly>
                                @endif
                            </div>
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="optional_exam" 
                           ...
                           class="form-input w-full rounded-lg border-gray-300 bg-gray-100 text-gray-500" 
                           readonly />
                </div>
            ...
            <div class="flex justify-end space-x-4">
                ...
                <button type="submit" 
                        class="bg-ecgtech-600 text-white px-8 py-3 rounded-lg shadow hover:bg-ecgtech-700 transition-colors font-semibold tracking-wide">
                    <i class="fas fa-save mr-2"></i>{{ $medicalChecklist ? 'Update' : 'Submit' }} ECG Report
                </button>
            </div>
        </form>
    </div>
