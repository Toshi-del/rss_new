    ...
    <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-200 mb-8">
        ...
        <form action="{{ route('nurse.pre-employment.update', $preEmployment->id) }}" method="POST" class="space-y-8">
            ...
            <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                    <div>
                        ...
                        <textarea name="illness_history" class="form-textarea w-full h-16 rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500">{{ old('illness_history', $preEmployment->illness_history) }}</textarea>
                    </div>
                    <div>
                        <label class="block text-xs font-semibold uppercase mb-1">Accidents / Operations</label>
                        <textarea name="accidents_operations" class="form-textarea w-full h-16 rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500">{{ old('accidents_operations', $preEmployment->accidents_operations) }}</textarea>
                    </div>
                    <div>
                        <label class="block text-xs font-semibold uppercase mb-1">Past Medical History</label>
                        <textarea name="past_medical_history" class="form-textarea w-full h-16 rounded-lg border-gray-300 focus:ring-green-500 focus:border-green-500">{{ old('past_medical_history', $preEmployment->past_medical_history) }}</textarea>
                    </div>
                </div>
                <div class="mb-4">
                    ...
                    <div class="flex flex-wrap gap-3">
                        @php
                            $family = old('family_history', $preEmployment->family_history ?? []);
            ...
            <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                ...
                <div class="flex flex-wrap gap-3">
                    @php
                        $habits = old('personal_habits', $preEmployment->personal_habits ?? []);
            ...
            <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
                ...
                @php
                    $lab = old('lab_report', $preEmployment->lab_report ?? []);
