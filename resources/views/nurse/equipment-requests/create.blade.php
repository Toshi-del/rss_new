...
@section('page-description', 'Submit a new equipment request for medical supplies')
...
<div class="space-y-8">
        ...
        <div class="bg-emerald-600 px-8 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('nurse.equipment-requests.index') }}" 
                       class="inline-flex items-center px-4 py-2 bg-white/10 text-white font-medium rounded-xl hover:bg-white/20 transition-all duration-200 border border-white/20 backdrop-blur-sm">
    ...
    <div class="content-card rounded-xl overflow-hidden shadow-lg border border-gray-200">
        ...
        <form action="{{ route('nurse.equipment-requests.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="department" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                        ...
                        <option value="nurse" {{ old('department') == 'nurse' ? 'selected' : '' }}>Nursing Department</option>
                        <option value="doctor" {{ old('department') == 'doctor' ? 'selected' : '' }}>Medical Department</option>
                ...
                <div>
                    ...
                    <select name="priority" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                        ...
                        <option value="medium" {{ old('priority') == 'medium' ? 'selected' : '' }}>Medium - Needed soon</option>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="date_needed" value="{{ old('date_needed') }}" required
                           min="{{ date('Y-m-d') }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                    @error('date_needed')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    ...
                                    <label class="flex items-start space-x-3 cursor-pointer">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="flex items-center justify-between text-xs">
                                                ...
                                                <span class="text-emerald-600 font-medium">{{ $item->current_quantity }} {{ $item->unit }}</span>
                                            </div>
                                            <div class="mt-2">
