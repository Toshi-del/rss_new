        ...
        <form action="{{ isset($medicalChecklist) && $medicalChecklist->id ? route('doctor.medical-checklist.update', $medicalChecklist->id) : route('doctor.medical-checklist.store') }}" method="POST" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $medicalChecklist->name ?? $name ?? '') }}" class="form-input w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" required />
                </div>
                <div>
                    <label class="block text-xs font-semibold uppercase mb-1">Date</label>
                    <input type="date" name="date" value="{{ old('date', $medicalChecklist->date ?? $date ?? '') }}" class="form-input w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" required />
                </div>
                <div>
                    <label class="block text-xs font-semibold uppercase mb-1">Age</label>
                    <input type="number" name="age" value="{{ old('age', $medicalChecklist->age ?? $age ?? '') }}" class="form-input w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" required />
                </div>
                <div>
                    <label class="block text-xs font-semibold uppercase mb-1">Number</label>
                    <input type="text" name="number" value="{{ old('number', $medicalChecklist->number ?? $number ?? '') }}" class="form-input w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
                </div>
            </div>
            ...
            <!-- Optional Exam and Doctor Signature -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="doctor_signature" value="{{ old('doctor_signature', $medicalChecklist->doctor_signature ?? $doctorSignature ?? '') }}" class="form-input w-full rounded-lg border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
                </div>
            </div>
