                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 border-b text-xs">
                                ...
                                @endphp
                                <input type="text" name="lab_report[{{ $testKey }}]" class="form-input w-full rounded border-gray-300 text-xs" value="{{ old('lab_report.'.$testKey, data_get($annualPhysical->lab_report, $testKey, '')) }}">
                            </td>
                            <td class="px-4 py-2 border-b text-xs">
                                @php
                                    $findingsKey = $testKey . '_findings';
                                @endphp
                                <input type="text" name="lab_report[{{ $findingsKey }}]" class="form-input w-full rounded border-gray-300 text-xs" value="{{ old('lab_report.'.$findingsKey, data_get($annualPhysical->lab_report, $findingsKey, '')) }}">
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
