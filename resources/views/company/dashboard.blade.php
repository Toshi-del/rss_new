            ...
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Dec 15, 2024</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Physical Exam, Vision Test</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">CBC, Blood Sugar, Cholesterol</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
                                Passed
                            </span>
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Dec 16, 2024</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Physical Exam, Hearing Test</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">CBC, Blood Sugar</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800">
                                Pending
                            </span>
