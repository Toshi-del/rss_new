                ...
                <table class="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border border-gray-300 px-4 py-3">
                                <input type="text" name="lab_report[hbsag_screening_findings]" 
                                       value="{{ old('lab_report.hbsag_screening_findings', $examination->lab_report['hbsag_screening_findings'] ?? '') }}"
                                       class="w-full px-2 py-1 border-0 focus:ring-0 focus:outline-none text-sm"
                                       placeholder="Enter findings">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="border border-gray-300 px-4 py-3">
                                <input type="text" name="lab_report[hepa_a_igg_igm_findings]" 
                                       value="{{ old('lab_report.hepa_a_igg_igm_findings', $examination->lab_report['hepa_a_igg_igm_findings'] ?? '') }}"
                                       class="w-full px-2 py-1 border-0 focus:ring-0 focus:outline-none text-sm"
                                       placeholder="Enter findings">
                            </td>
                        </tr>
