    ...
    <div class="flex h-full">
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-72 sidebar-glass transform -translate-x-full transition-all duration-500 ease-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col custom-scrollbar">
            ...
            <div class="flex items-center justify-between h-20 px-6 border-b border-white/10">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-white/60 text-xs font-medium">Company Portal</p>
                    </div>
                </div>
            ...
            <nav class="flex-1 px-4 py-6 space-y-3 overflow-y-auto custom-scrollbar">
                ...
                <a href="{{ route('company.dashboard') }}" class="nav-item flex items-center px-4 py-4 text-white/90 rounded-2xl font-medium {{ request()->routeIs('company.dashboard') ? 'active' : '' }}">
                    <i class="fas fa-chart-line text-lg mr-4 floating-icon"></i>
                    <span>Dashboard</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-60"></i>
                </a>
                
                <div class="text-white/40 text-xs font-semibold uppercase tracking-wider px-4 mt-8 mb-4">Services</div>
                
                <a href="{{ route('company.appointments.index') }}" class="nav-item flex items-center px-4 py-4 text-white/90 rounded-2xl font-medium {{ request()->routeIs('company.appointments.*') ? 'active' : '' }}">
                    <i class="fas fa-calendar-check text-lg mr-4"></i>
                    <span>Appointments</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-60"></i>
                </a>
                
                <a href="{{ route('company.pre-employment.index') }}" class="nav-item flex items-center px-4 py-4 text-white/90 rounded-2xl font-medium {{ request()->routeIs('company.pre-employment.*') ? 'active' : '' }}">
                    <i class="fas fa-briefcase text-lg mr-4"></i>
                    <span>Pre-Employment</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-60"></i>
                </a>
                
                <a href="{{ route('company.medical-results') }}" class="nav-item flex items-center px-4 py-4 text-white/90 rounded-2xl font-medium {{ request()->routeIs('company.medical-results*') ? 'active' : '' }}">
                ...
                <a href="{{ route('company.account-invitations.index') }}" class="nav-item flex items-center px-4 py-4 text-white/90 rounded-2xl font-medium {{ request()->routeIs('company.account-invitations*') ? 'active' : '' }}">
                    <i class="fas fa-link text-lg mr-4"></i>
                ...
                <a href="{{ route('company.messages') }}" class="nav-item flex items-center px-4 py-4 text-white/90 rounded-2xl font-medium {{ request()->routeIs('company.messages') ? 'active' : '' }}">
                ...
                <a href="{{ route('company.settings') }}" class="nav-item flex items-center px-4 py-4 text-white/90 rounded-2xl font-medium {{ request()->routeIs('company.settings*') ? 'active' : '' }}">
            ...
            <div class="p-6 border-t border-white/10">
                <div class="glass-morphism rounded-2xl p-4">
                    <div class="flex items-center space-x-3">
                        <div class="w-12 h-12 rounded-2xl bg-blue-600 flex items-center justify-center text-white font-bold text-lg pulse-icon">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-white/60 text-xs">Company Administrator</p>
                        </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-white">
                                @yield('title', 'Company Dashboard')
                            </h1>
                            <p class="text-white/60 text-sm font-medium">@yield('page-description', 'Welcome back, ' . (Auth::user()->full_name ?? 'Company Admin') . '!')</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden md:block">
                            <div class="relative">
                                ...
                                <input type="text" 
                                       class="glass-morphism pl-12 pr-4 py-3 rounded-2xl text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300 w-80" 
                                       placeholder="Search applicants, appointments...">
                            </div>
                        </div>
