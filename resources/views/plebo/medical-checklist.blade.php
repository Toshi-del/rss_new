<div class="max-w-4xl mx-auto py-8">
    <div class="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
        ...
        <form action="{{ isset($medicalChecklist) && $medicalChecklist->id ? route('plebo.medical-checklist.update', $medicalChecklist->id) : route('plebo.medical-checklist.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                @if($field === 'blood_extraction')
                                    <input type="text" name="blood_extraction_done_by" 
                                           value="{{ old('blood_extraction_done_by', $medicalChecklist->blood_extraction_done_by ?? '') }}" 
