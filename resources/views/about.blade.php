            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="flex flex-col rounded-2xl border border-gray-100 bg-white shadow-sm overflow-hidden">
                    <div class="relative h-56 bg-gray-100">
                        <img src="{{ asset('images/admin.jpg') }}" alt="Administrator" class="w-full h-full object-cover" onerror="this.style.display='none'; this.parentElement.querySelector('.avatar-fallback').classList.remove('hidden')">
                ...
                <div class="flex flex-col rounded-2xl border border-gray-100 bg-white shadow-sm overflow-hidden">
                    <div class="relative h-56 bg-gray-100">
                        <img src="{{ asset('images/doctor.jpg') }}" alt="Assistant Administrator" class="w-full h-full object-cover" onerror="this.style.display='none'; this.parentElement.querySelector('.avatar-fallback').classList.remove('hidden')">
                        <div class="avatar-fallback hidden absolute inset-0 grid place-items-center text-blue-600">
                            <i class="fa-solid fa-user-tie text-5xl"></i>
                        </div>
                    </div>
                ...
                <div class="flex flex-col rounded-2xl border border-gray-100 bg-white shadow-sm overflow-hidden">
                    <div class="relative h-56 bg-gray-100">
                        <img src="{{ asset('images/medtech.jpg') }}" alt="Head Medical Technologist" class="w-full h-full object-cover" onerror="this.style.display='none'; this.parentElement.querySelector('.avatar-fallback').classList.remove('hidden')">
                        <div class="avatar-fallback hidden absolute inset-0 grid place-items-center text-blue-600">
                ...
                <div class="flex flex-col rounded-2xl border border-gray-100 bg-white shadow-sm overflow-hidden">
                    <div class="relative h-56 bg-gray-100">
                        <img src="{{ asset('images/nurse.jpg') }}" alt="Finance Head" class="w-full h-full object-cover" onerror="this.style.display='none'; this.parentElement.querySelector('.avatar-fallback').classList.remove('hidden')">
                        <div class="avatar-fallback hidden absolute inset-0 grid place-items-center text-blue-600">
                            <i class="fa-solid fa-user-tie text-5xl"></i></div>
                    </div>
                    <div class="flex-1 p-5">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                    ...
                    <div class="flex items-center">
                        <div class="w-12 h-12 rounded-full overflow-hidden mr-4 bg-gray-200 flex items-center justify-center">
                            <img src="{{ asset('images/testimonial1.jpg') }}" alt="Patient" class="w-full h-full object-cover" onerror="this.style.display='none'; this.parentElement.innerHTML='<i class=\'fa-solid fa-user text-gray-500\'></i>'">
                        </div>
                        <div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                    ...
                    <div class="flex items-center">
                        <div class="w-12 h-12 rounded-full overflow-hidden mr-4 bg-gray-200 flex items-center justify-center">
                            <img src="{{ asset('images/testimonial2.jpg') }}" alt="Patient" class="w-full h-full object-cover" onerror="this.style.display='none'; this.parentElement.innerHTML='<i class=\'fa-solid fa-user text-gray-500\'></i>'">
                        </div>
                        <div>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
                    ...
                    <div class="flex items-center">
                        <div class="w-12 h-12 rounded-full overflow-hidden mr-4 bg-gray-200 flex items-center justify-center">
                            <img src="{{ asset('images/testimonial3.jpg') }}" alt="Patient" class="w-full h-full object-cover" onerror="this.style.display='none'; this.parentElement.innerHTML='<i class=\'fa-solid fa-user text-gray-500\'></i>'">
                        </div>
                        <div>
        ...
        <div id="registerContent" class="bg-white w-full max-w-lg rounded-2xl shadow-2xl transform transition duration-300 scale-95 opacity-0">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                    <a href="{{ route('register') }}" class="block w-full text-center px-6 py-4 rounded-xl border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white font-semibold transition"><i class="fa-solid fa-user mr-2"></i> Individual</a>
                    <a href="{{ route('register') }}?corporate=1" class="block w-full text-center px-6 py-4 rounded-xl bg-blue-600 text-white hover:bg-blue-700 font-semibold transition"><i class="fa-solid fa-building mr-2"></i> Corporate</a>
                </div>
