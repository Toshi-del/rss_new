<?php $__env->startSection('title', 'Pre-Employment Records'); ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $preEmployments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $preEmployment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-gray-500">ID: <?php echo e($preEmployment->id); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($preEmployment->age); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <span class="px-2 py-1 text-xs font-medium rounded-full <?php echo e($preEmployment->sex === 'Male' ? 'bg-blue-100 text-blue-800' : 'bg-pink-100 text-pink-800'); ?>">
                                <?php echo e($preEmployment->sex); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($preEmployment->email); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($preEmployment->phone_number ?? 'N/A'); ?></td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <div class="flex items-center">
                                <i class="fas fa-building text-gray-400 mr-2"></i>
                                <?php echo e($preEmployment->company_name); ?>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500">
                            ...
                            ?>
                            <?php if($groupedTests->isNotEmpty()): ?>
                                <div class="space-y-1">
                            ...
                            <?php elseif($preEmployment->medicalTestCategory): ?>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500">
                            <?php if($selectedTests->isNotEmpty()): ?>
                                <div class="space-y-1">
                                    <?php $__currentLoopData = $selectedTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="text-xs bg-gray-100 px-2 py-1 rounded mb-1">
                                            <?php echo e($test['test_name']); ?>

                                            <?php if($test['price'] > 0): ?>
                                                <span class="text-emerald-600 font-medium">(₱<?php echo e(number_format($test['price'], 2)); ?>)</span>
                                            <?php endif; ?>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($selectedTests->count() > 3): ?>
                                        <div class="text-xs text-blue-600 font-medium">
                                            +<?php echo e($selectedTests->count() - 3); ?> more tests
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php elseif($preEmployment->medicalTest): ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <?php if($hasSubmittedData): ?>
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div class="text-xs text-gray-500">
                                        <?php echo e($latestExamination->updated_at->format('M d, Y')); ?>
                            ...
                            <?php elseif($examinations->isNotEmpty()): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.pathologist', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new-1\resources\views/pathologist/pre-employment.blade.php ENDPATH**/ ?>