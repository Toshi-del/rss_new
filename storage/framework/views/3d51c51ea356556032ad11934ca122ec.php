<?php $__env->startSection('title', 'Appointment Details - RSS Citi Health Services'); ?>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-emerald-100 text-sm">Appointment ID: #<?php echo e($appointment->id); ?></p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e(\Carbon\Carbon::parse($appointment->appointment_date)->format('l, F d, Y')); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e($appointment->time_slot ?? 'To be determined'); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e($appointment->patient_count); ?> <?php echo e($appointment->patient_count == 1 ? 'patient' : 'patients'); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e($appointment->creator->company ?? 'N/A'); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e($appointment->creator->email ?? 'N/A'); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e($appointment->created_at->format('M d, Y \a\t g:i A')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-card rounded-xl overflow-hidden shadow-lg border border-gray-200">
                ...
                <div class="p-6">
                    <?php if($appointment->medicalTestCategory && $appointment->medicalTest): ?>
                        <div class="space-y-4">
                            <div class="bg-amber-50 p-4 rounded-lg border border-amber-200">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h5 class="font-semibold text-amber-800"><?php echo e($appointment->medicalTestCategory->name); ?></h5>
                                        <p class="text-sm text-amber-600 mt-1"><?php echo e($appointment->medicalTest->name); ?></p>
                                    </div>
                                    <div class="text-right">
                                        <div class="flex items-center space-x-2 text-green-700">
                                            <i class="fas fa-peso-sign text-sm"></i>
                                            <span class="font-semibold"><?php echo e(number_format((float)($appointment->medicalTest->price ?? 0), 2)); ?></span>
                                        </div>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="text-right">
                                        <div class="flex items-center space-x-2 text-green-700">
                                            ...
                                            <span class="text-lg font-bold"><?php echo e($appointment->formatted_total_price ?? '0.00'); ?></span>
                                        </div>
                                        <p class="text-xs text-green-600"><?php echo e($appointment->patient_count); ?> × ₱<?php echo e(number_format((float)($appointment->medicalTest->price ?? 0), 2)); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="bg-amber-50 p-4 rounded-lg border border-amber-200">
                            <div class="text-center py-4">
                                ...
                                <p class="text-amber-600 text-sm">Examination type: <?php echo e($appointment->appointment_type ?? 'General Checkup'); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center">
                                            <span class="text-white font-bold text-sm">
                                                <?php echo e(substr($patient->first_name ?? 'N', 0, 1)); ?><?php echo e(substr($patient->last_name ?? 'A', 0, 1)); ?>

                                            </span>
                                        </div>
                                        <div>
                                            <p class="font-semibold text-blue-800"><?php echo e($patient->first_name); ?> <?php echo e($patient->last_name); ?></p>
                                            <p class="text-sm text-blue-600"><?php echo e($patient->email ?? 'No email'); ?></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php $__currentLoopData = $assignmentsByRole; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role => $assignments): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-purple-50 p-4 rounded-lg border border-purple-200">
                                    <div class="flex items-center justify-between mb-2">
                                        <h5 class="font-semibold text-purple-800"><?php echo e(ucfirst(str_replace('_', ' ', $role))); ?></h5>
                                        <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                                            <?php echo e(count($assignments)); ?> <?php echo e(count($assignments) == 1 ? 'assignment' : 'assignments'); ?>

                                        </span>
                                    </div>
                                    <div class="space-y-1">
                                        <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <p class="text-sm text-purple-600">• <?php echo e($assignment->description ?? 'Test assignment'); ?></p>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="p-6 space-y-3">
                    <?php if($appointment->status !== 'approved'): ?>
                        <button type="button" 
                                ...
                                onclick="openApproveModal(<?php echo e($appointment->id); ?>)">
                    ...
                    <?php if($appointment->status !== 'declined'): ?>
                        <button type="button" 
                                ...
                                onclick="openDeclineModal(<?php echo e($appointment->id); ?>)">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500"><?php echo e($appointment->created_at->format('M d, Y \a\t g:i A')); ?></p>
                            </div>
                        </div>
                        ...
                        <?php if($appointment->updated_at != $appointment->created_at): ?>
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500"><?php echo e($appointment->updated_at->format('M d, Y \a\t g:i A')); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
...
<script>
let currentAppointmentId = <?php echo e($appointment->id); ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/admin/appointment-details.blade.php ENDPATH**/ ?>