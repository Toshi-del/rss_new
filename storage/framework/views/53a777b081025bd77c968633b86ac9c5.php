<?php $__env->startSection('title', 'Page Content Management - RSS Citi Health Services'); ?>
<?php $__env->startSection('page-title', 'Page Content Management'); ?>
...
<div class="space-y-8">
    ...
    <?php if($pagesSummary->count() > 0): ?>
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <?php $__currentLoopData = $pagesSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $summary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="content-card rounded-xl p-6 border-l-4 border-<?php echo e($summary->page_name === 'login' ? 'blue' : ($summary->page_name === 'about' ? 'emerald' : ($summary->page_name === 'location' ? 'amber' : 'purple'))); ?>-500 hover:shadow-lg transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600 mb-1 capitalize"><?php echo e($summary->page_name); ?> Page</p>
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($summary->content_count); ?></p>
                    <p class="text-xs text-gray-500 mt-1">Last updated: <?php echo e(\Carbon\Carbon::parse($summary->last_updated)->format('M j, Y')); ?></p>
                </div>
                <div class="w-12 h-12 bg-<?php echo e($summary->page_name === 'login' ? 'blue' : ($summary->page_name === 'about' ? 'emerald' : ($summary->page_name === 'location' ? 'amber' : 'purple'))); ?>-100 rounded-xl flex items-center justify-center">
                    <i class="fas fa-<?php echo e($summary->page_name === 'login' ? 'sign-in-alt' : ($summary->page_name === 'about' ? 'info-circle' : ($summary->page_name === 'location' ? 'map-marker-alt' : 'cogs'))); ?> text-<?php echo e($summary->page_name === 'login' ? 'blue' : ($summary->page_name === 'about' ? 'emerald' : ($summary->page_name === 'location' ? 'amber' : 'purple'))); ?>-600 text-lg"></i>
                </div>
            </div>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="content-card rounded-xl overflow-hidden shadow-lg border border-gray-200">
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-3">
                    <form method="POST" action="<?php echo e(route('admin.page-contents.initialize-defaults')); ?>" class="inline">
                        <?php echo csrf_field(); ?>
                    ...
                    <a href="<?php echo e(route('admin.page-contents.create', ['page' => $selectedPage])); ?>" class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors">
        ...
        <div class="bg-white px-8 py-4 border-b border-gray-200">
            <nav class="flex space-x-8">
                ...
                <a href="<?php echo e(route('admin.page-contents.index', ['page' => $page])); ?>" 
                   class="py-2 px-4 rounded-lg font-medium text-sm transition-colors <?php echo e($selectedPage === $page ? 'bg-blue-100 text-blue-600' : 'text-gray-500 hover:text-gray-700 hover:bg-gray-50'); ?>">
                    <i class="fas fa-<?php echo e($page === 'login' ? 'sign-in-alt' : ($page === 'about' ? 'info-circle' : ($page === 'location' ? 'map-marker-alt' : 'cogs'))); ?> mr-2"></i>
    ...
    <div class="content-card rounded-xl p-8 shadow-lg border border-gray-200">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h3 class="text-xl font-bold text-gray-900"><?php echo e(ucfirst($selectedPage)); ?> Page Content</h3>
                <p class="text-gray-600 text-sm mt-1">Manage and edit content sections for the <?php echo e($selectedPage); ?> page</p>
            </div>
            <div class="flex items-center space-x-3">
                <?php if($selectedPage === 'services'): ?>
        ...
        <form method="POST" action="<?php echo e(route('admin.page-contents.bulk-update')); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="page_name" value="<?php echo e($selectedPage); ?>">
            ...
            <div class="space-y-4">
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-xl p-6 hover:shadow-md transition-all duration-200">
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex-1">
                            <div class="flex items-center space-x-3 mb-2">
                                <h4 class="text-lg font-semibold text-gray-900"><?php echo e($content->display_name); ?></h4>
                                <span class="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">
                                    <?php echo e(ucfirst($content->content_type)); ?>

                                </span>
                                <span class="px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 rounded-full">
                                    Order: <?php echo e($content->sort_order); ?>

                                </span>
                            </div>
                            <?php if($content->description): ?>
                                <p class="text-sm text-gray-600 mb-2"><?php echo e($content->description); ?></p>
                            <?php endif; ?>
                            <p class="text-xs text-gray-500">Section Key: <code class="bg-gray-200 px-1 rounded"><?php echo e($content->section_key); ?></code></p>
                        </div>
                        <div class="flex items-center space-x-3">
                            <label class="flex items-center">
                                <input type="checkbox" 
                                       name="contents[<?php echo e($content->id); ?>][is_active]" 
                                       value="1"
                                       <?php echo e($content->is_active ? 'checked' : ''); ?>
                            ...
                            <button type="button" 
                                    ...
                                    onclick="deleteContent(<?php echo e($content->id); ?>, '<?php echo e(addslashes($content->display_name)); ?>')">
                    ...
                    <div class="bg-white rounded-lg p-4 border border-gray-200">
                        <?php if($content->content_type === 'textarea'): ?>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Content</label>
                            <textarea name="contents[<?php echo e($content->id); ?>][content_value]" 
                                      rows="4" 
                                      ...
                                      placeholder="Enter content..."><?php echo e($content->content_value); ?></textarea>
                        <?php elseif($content->content_type === 'text'): ?>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Content</label>
                            <input type="text" 
                                   name="contents[<?php echo e($content->id); ?>][content_value]" 
                                   value="<?php echo e($content->content_value); ?>"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                   placeholder="Enter content...">
                        <?php elseif($content->content_type === 'url'): ?>
                            ...
                            <div class="space-y-3">
                                ...
                                <?php if($content->content_value): ?>
                                    <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                                        <img src="<?php echo e($content->content_value); ?>" 
                                             alt="Preview" 
                                             class="w-16 h-16 object-cover rounded-lg border border-gray-200"
                                             onerror="this.style.display='none'">
                                        <div class="text-sm text-gray-600">
                                            <p class="font-medium">Image Preview</p>
                                            <p class="text-xs"><?php echo e(basename($content->content_value)); ?></p>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
        ...
        <div class="text-center py-16">
            ...
            <p class="text-gray-600 mb-8 max-w-md mx-auto">No content sections found for the <?php echo e($selectedPage); ?> page. Get started by adding content or initializing default sections.</p>
            <div class="flex items-center justify-center space-x-4">
                <a href="<?php echo e(route('admin.page-contents.create', ['page' => $selectedPage])); ?>" 
...
<div id="addServiceModal" class="hidden fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
    <div class="relative mx-auto p-0 border-0 w-full max-w-md shadow-2xl rounded-xl bg-white">
        ...
        <!-- Modal Body -->
        <div class="p-6">
            <form method="POST" action="<?php echo e(route('admin.page-contents.add-service-card')); ?>">
                <?php echo csrf_field(); ?>
                <div class="space-y-5">
                    <div>
...
<?php if($contents->count() > 0): ?>
    <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <form id="delete-form-<?php echo e($content->id); ?>" method="POST" action="<?php echo e(route('admin.page-contents.destroy', $content)); ?>" style="display: none;">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/admin/page-contents.blade.php ENDPATH**/ ?>