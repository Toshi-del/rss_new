                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <!-- Examination -->
                                            <?php if($preEmploymentExam): ?>
                                                <a href="<?php echo e(route('nurse.pre-employment.edit', $preEmploymentExam->id)); ?>" class="p-2 text-emerald-600 hover:text-emerald-900 hover:bg-emerald-50 rounded-lg transition-colors" title="Edit Examination">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                            <?php else: ?>
                                                <?php if($medicalChecklist && !empty($medicalChecklist->physical_exam_done_by)): ?>
                                                    <a href="<?php echo e(route('nurse.pre-employment.create', ['record_id' => $preEmployment->id])); ?>" class="p-2 text-emerald-600 hover:text-emerald-900 hover:bg-emerald-50 rounded-lg transition-colors" title="Create Examination">
                                            ...
                                            <!-- Medical Checklist -->
                                            <a href="<?php echo e(route('nurse.medical-checklist.pre-employment', $preEmployment->id)); ?>" class="p-2 text-purple-600 hover:text-purple-900 hover:bg-purple-50 rounded-lg transition-colors" title="Medical Checklist">
