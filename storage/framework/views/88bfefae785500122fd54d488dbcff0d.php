        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center space-x-2">
                    ...
                    <a href="<?php echo e(route('patient.profile')); ?>" class="nav-item px-4 py-2 text-gray-700">
                ...
                <div class="flex items-center space-x-4">
                    <div class="hidden md:flex items-center space-x-3">
                        <div class="text-right">
                            <p class="font-semibold text-gray-800"><?php echo e(Auth::user()->fname); ?> <?php echo e(Auth::user()->lname); ?></p>
        ...
        <div class="content-card patient-gradient rounded-2xl p-8 mb-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold mb-2 text-white">Welcome, <?php echo e(Auth::user()->fname); ?>!</h1>
        ...
        <div class="content-card rounded-2xl p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="p-4 bg-gray-50 rounded-xl">
                    ...
                    <p class="font-semibold text-gray-800"><?php echo e(Auth::user()->phone ?? 'Not provided'); ?></p>
                </div>
                <div class="p-4 bg-gray-50 rounded-xl">
                    <div class="flex items-center space-x-2 mb-2">
                    ...
                    <p class="font-semibold text-gray-800"><?php echo e(Auth::user()->company ?? 'Not specified'); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="p-6">
                ...
                <div id="tests" class="tab-content">
                        ...
                        <div class="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-4 border border-blue-200">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="text-2xl font-bold text-blue-700"><?php echo e(Auth::user()->patientAppointments()->count()); ?></p>
                            ...
                            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-4 border border-green-200">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="text-2xl font-bold text-green-700"><?php echo e(Auth::user()->patientAppointments()->where('status', 'approved')->count()); ?></p>
                            ...
                            <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl p-4 border border-yellow-200">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="text-2xl font-bold text-yellow-700"><?php echo e(Auth::user()->patientAppointments()->where('status', 'pending')->count()); ?></p>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <?php $__empty_1 = true; $__currentLoopData = Auth::user()->patientAppointments()->orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="bg-white rounded-2xl border border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all duration-300 overflow-hidden">
                                <!-- Status Header -->
                                <div class="px-6 py-4 <?php echo e($appointment->status == 'approved' ? 'bg-gradient-to-r from-green-500 to-green-600' : ($appointment->status == 'pending' ? 'bg-gradient-to-r from-yellow-500 to-yellow-600' : 'bg-gradient-to-r from-red-500 to-red-600')); ?>">
                                ...
                                <div class="p-6">
                                    <div class="mb-4">
                                        <h5 class="text-lg font-bold text-gray-800 mb-2"><?php echo e($appointment->appointment_type ?? 'General Checkup'); ?></h5>
                                        <div class="flex items-center space-x-2 text-gray-600 mb-2">
                                            <i class="fas fa-calendar text-blue-500"></i>
                                            <span class="font-medium"><?php echo e(\Carbon\Carbon::parse($appointment->appointment_date)->format('l, M d, Y')); ?></span>
                                        </div>
                                        <div class="flex items-center space-x-2 text-gray-600">
                                            <i class="fas fa-clock text-blue-500"></i>
                                            <span class="font-medium"><?php echo e($appointment->time_slot); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border-t border-gray-100 pt-4">
                                        <div class="flex items-center justify-between text-sm">
                                            ...
                                            <span class="font-medium text-gray-700"><?php echo e($appointment->created_at->format('M d, Y')); ?></span>
                                        </div>
                                    </div>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <?php $__empty_1 = true; $__currentLoopData = Auth::user()->preEmploymentRecords()->orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="bg-white rounded-2xl border border-gray-200 hover:border-orange-300 hover:shadow-lg transition-all duration-300 overflow-hidden">
                                <!-- Status Header -->
                                <div class="px-6 py-4 <?php echo e($record->status == 'completed' ? 'bg-gradient-to-r from-green-500 to-green-600' : ($record->status == 'in_progress' ? 'bg-gradient-to-r from-blue-500 to-blue-600' : ($record->status == 'pending' ? 'bg-gradient-to-r from-yellow-500 to-yellow-600' : 'bg-gradient-to-r from-gray-500 to-gray-600'))); ?>">
                                    <div class="flex items-center justify-between text-white">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <span class="font-semibold"><?php echo e(ucfirst($record->status ?? 'Unknown')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                ...
                                <div class="p-6">
                                    <div class="mb-4">
                                        <h5 class="text-lg font-bold text-gray-800 mb-2"><?php echo e($record->full_name); ?></h5>
                                        <div class="grid grid-cols-2 gap-4 text-sm">
                                            <div class="flex items-center space-x-2 text-gray-600">
                                                <i class="fas fa-user text-orange-500"></i>
                                                <span class="font-medium"><?php echo e($record->age); ?> years, <?php echo e($record->sex); ?></span>
                                            </div>
                                            <div class="flex items-center space-x-2 text-gray-600">
                                                <i class="fas fa-stethoscope text-orange-500"></i>
                                                <span class="font-medium"><?php echo e($record->medical_exam_type); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4 p-3 bg-orange-50 rounded-xl border border-orange-200">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="font-semibold text-orange-800"><?php echo e($record->company_name); ?></span>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="border-t border-gray-100 pt-4">
                                        <div class="flex items-center justify-between text-sm">
                                            ...
                                            <span class="font-medium text-gray-700"><?php echo e($record->created_at->format('M d, Y')); ?></span>
                                        </div>
                                    </div>
                ...
                <div id="results" class="tab-content hidden">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
                            <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl p-4 border border-emerald-200">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="text-2xl font-bold text-emerald-700"><?php echo e(Auth::user()->preEmploymentExaminations()->count()); ?></p>
                            ...
                            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-4 border border-blue-200">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="text-2xl font-bold text-blue-700"><?php echo e(Auth::user()->annualPhysicalExaminations()->count()); ?></p>
                            ...
                            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-4 border border-purple-200">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="text-2xl font-bold text-purple-700"><?php echo e(Auth::user()->preEmploymentExaminations()->whereNotNull('lab_findings')->count() + Auth::user()->annualPhysicalExaminations()->whereNotNull('lab_findings')->count()); ?></p>
                            ...
                            <div class="bg-gradient-to-br from-teal-50 to-teal-100 rounded-2xl p-4 border border-teal-200">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <p class="text-2xl font-bold text-teal-700"><?php echo e(Auth::user()->preEmploymentExaminations()->whereNotNull('ecg')->count() + Auth::user()->annualPhysicalExaminations()->whereNotNull('ecg')->count()); ?></p>
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <?php $__empty_1 = true; $__currentLoopData = Auth::user()->preEmploymentExaminations()->orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="bg-white rounded-2xl border border-gray-200 hover:border-emerald-300 hover:shadow-lg transition-all duration-300 overflow-hidden">
                                <!-- Status Header -->
                                <div class="px-6 py-4 <?php echo e($exam->status == 'completed' ? 'bg-gradient-to-r from-emerald-500 to-emerald-600' : ($exam->status == 'in_progress' ? 'bg-gradient-to-r from-blue-500 to-blue-600' : ($exam->status == 'pending' ? 'bg-gradient-to-r from-yellow-500 to-yellow-600' : 'bg-gradient-to-r from-gray-500 to-gray-600'))); ?>">
                                    <div class="flex items-center justify-between text-white">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <?php else: ?>
                                                <i class="fas fa-question-circle"></i>
                                                <span class="font-semibold"><?php echo e(ucfirst($exam->status ?? 'Unknown')); ?></span>
                                            <?php endif; ?>
                                        </div>
                                ...
                                <div class="p-6">
                                    <div class="mb-4">
                                        <div class="flex items-center space-x-2 text-gray-600 mb-3">
                                            ...
                                            <span class="font-medium"><?php echo e($exam->date ? $exam->date->format('l, M d, Y') : 'Date not set'); ?></span>
                                        </div>
                                    </div>
                                    
                                    <!-- Results Summary -->
                                    <div class="grid grid-cols-3 gap-3 mb-4">
                                        <div class="text-center p-3 <?php echo e(($exam->physical_findings && count($exam->physical_findings) > 0) ? 'bg-green-50 border border-green-200' : 'bg-gray-50 border border-gray-200'); ?> rounded-xl">
                                            <i class="fas fa-stethoscope <?php echo e(($exam->physical_findings && count($exam->physical_findings) > 0) ? 'text-green-600' : 'text-gray-400'); ?> text-lg mb-1"></i>
                                            <p class="text-xs font-medium <?php echo e(($exam->physical_findings && count($exam->physical_findings) > 0) ? 'text-green-700' : 'text-gray-500'); ?>">Physical</p>
                                        </div>
                                        <div class="text-center p-3 <?php echo e(($exam->lab_findings && count($exam->lab_findings) > 0) ? 'bg-purple-50 border border-purple-200' : 'bg-gray-50 border border-gray-200'); ?> rounded-xl">
                                            <i class="fas fa-flask <?php echo e(($exam->lab_findings && count($exam->lab_findings) > 0) ? 'text-purple-600' : 'text-gray-400'); ?> text-lg mb-1"></i>
                                            <p class="text-xs font-medium <?php echo e(($exam->lab_findings && count($exam->lab_findings) > 0) ? 'text-purple-700' : 'text-gray-500'); ?>">Lab Tests</p>
                                        </div>
                                        <div class="text-center p-3 <?php echo e($exam->ecg ? 'bg-teal-50 border border-teal-200' : 'bg-gray-50 border border-gray-200'); ?> rounded-xl">
                                            <i class="fas fa-heartbeat <?php echo e($exam->ecg ? 'text-teal-600' : 'text-gray-400'); ?> text-lg mb-1"></i>
                                            <p class="text-xs font-medium <?php echo e($exam->ecg ? 'text-teal-700' : 'text-gray-500'); ?>">ECG</p>
                                        </div>
                                    </div>
                                    
                                    <?php if($exam->status == 'completed'): ?>
                                    <div class="flex space-x-2">
                                        <button onclick="viewExamDetails('pre-employment', <?php echo e($exam->id); ?>)" class="flex-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-semibold py-2 px-4 rounded-xl transition-colors duration-200">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full bg-white rounded-lg overflow-hidden shadow-sm">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    <?php $__empty_1 = true; $__currentLoopData = Auth::user()->annualPhysicalExaminations()->orderBy('created_at', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-gray-50">
                                        <td class="py-3 px-4 text-sm"><?php echo e($exam->date ? $exam->date->format('M d, Y') : 'N/A'); ?></td>
                                        <td class="py-3 px-4">
                                            <?php if($exam->status == 'completed'): ?>
                                            ...
                                            <?php else: ?>
                                                <span class="px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-800"><?php echo e(ucfirst($exam->status ?? 'Unknown')); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="py-3 px-4 text-sm">
                                            <?php if($exam->physical_findings && count($exam->physical_findings) > 0): ?>
                                        ...
                                        <td class="py-3 px-4 text-sm">
                                            <?php if($exam->lab_findings && count($exam->lab_findings) > 0): ?>
                                                <span class="px-2 py-1 text-xs rounded-full bg-blue-100 text-blue-800">Available</span>
                                            <?php else: ?>
                                                <span class="px-2 py-1 text-xs rounded-full bg-gray-100 text-gray-600">Not Available</span>
                                            <?php endif; ?>
                                        ...
                                        <td class="py-3 px-4 text-sm">
                                            <button class="text-primary-600 hover:text-primary-800 font-medium" onclick="viewExamDetails('annual-physical', <?php echo e($exam->id); ?>)">
                                                View Details
                                            </button>
                                        </td>
                                    </tr>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-4 md:mb-0">
                    ...
                    <p class="text-gray-600 text-sm">&copy; <?php echo e(date('Y')); ?> RSS Citi Health Services. All rights reserved.</p>
                </div>
...
</html> <?php /**PATH C:\xampp\htdocs\rss_new\resources\views/patient/dashboard.blade.php ENDPATH**/ ?>