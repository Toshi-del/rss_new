...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Medical Technologist Dashboard - RSS Citi Health Services'); ?></title>
        ...
        <div class="w-72 glass-sidebar relative z-10 shadow-2xl flex flex-col h-full">
            ...
            <nav class="flex-1 px-6 py-8 space-y-2 overflow-y-auto">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="<?php echo e(route('nurse.dashboard')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('nurse.dashboard') ? 'active text-white' : ''); ?>">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="<?php echo e(route('nurse.pre-employment')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('nurse.pre-employment*') ? 'active text-white' : ''); ?>">
                            <i class="fas fa-user-md mr-4 text-lg"></i>
                            <span class="font-medium">Pre-Employment</span>
                        </a>
                        <a href="<?php echo e(route('nurse.annual-physical')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('nurse.annual-physical*') ? 'active text-white' : ''); ?>">
                            <i class="fas fa-file-medical mr-4 text-lg"></i>
                            <span class="font-medium">Annual Physical</span>
                        </a>
                        <a href="<?php echo e(route('nurse.opd')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('nurse.opd*') ? 'active text-white' : ''); ?>">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="<?php echo e(route('nurse.messages')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('nurse.messages*') ? 'active text-white' : ''); ?>">
                ...
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                    <div class="flex items-center space-x-3">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center text-white font-bold text-lg shadow-lg">
                            <?php echo e(substr(Auth::user()->fname ?? 'M', 0, 1)); ?>

                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-gray-900 font-semibold text-sm truncate">
                                <?php echo e(Auth::user()->fname ?? 'Medical'); ?> <?php echo e(Auth::user()->lname ?? 'Tech'); ?>
            ...
            <header class="content-card shadow-lg border-b border-gray-200 relative z-20">
                <div class="flex items-center justify-between px-8 py-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1"><?php echo $__env->yieldContent('page-description', 'Medical Technologist Portal'); ?></p>
                    </div>
...
</html> <?php /**PATH C:\xampp\htdocs\rss_new-1\resources\views/layouts/nurse.blade.php ENDPATH**/ ?>