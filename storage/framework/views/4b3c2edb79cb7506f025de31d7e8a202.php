<?php $__env->startSection('title', 'Add New Inventory Item'); ?>
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Add a new item to your inventory management system</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden">
            <div class="bg-blue-600 px-8 py-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-white">Item Information</h2>
                        <p class="text-blue-100 text-sm mt-1">Fill in the details for the new inventory item</p>
                    </div>
                </div>
            </div>

            <form action="<?php echo e(route('admin.inventory.store')); ?>" method="POST" class="p-8 space-y-8">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" 
                               name="minimum_stock" 
                               id="minimum_stock" 
                               value="<?php echo e(old('minimum_stock', 0)); ?>" 
                               min="0"
                               placeholder="0"
...
unset($__errorArgs, $__bag); ?>" 
                                required>
                            <option value="active" <?php echo e(old('item_status', 'active') == 'active' ? 'selected' : ''); ?>>Active</option>
                            <option value="inactive" <?php echo e(old('item_status') == 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                            <option value="out_of_stock" <?php echo e(old('item_status') == 'out_of_stock' ? 'selected' : ''); ?>>Out of Stock</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="bg-white/60 backdrop-blur-sm rounded-xl border border-white/20 p-6">
            <div class="flex items-start space-x-4">
                ...
                <div>
                    <h3 class="text-sm font-semibold text-gray-900 mb-2">Tips for Adding Inventory Items</h3>
                    <ul class="text-sm text-gray-600 space-y-1">
                        <li class="flex items-center space-x-2">
                            <i class="fas fa-check text-green-500 text-xs"></i>
                            <span>Use clear, descriptive names that are easy to identify</span>
                        </li>
                        <li class="flex items-center space-x-2">
                            <i class="fas fa-check text-green-500 text-xs"></i>
                            <span>Set appropriate minimum stock levels to avoid shortages</span>
                        </li>
                        <li class="flex items-center space-x-2">
                            <i class="fas fa-check text-green-500 text-xs"></i>
                            <span>Include supplier information for easy reordering</span>
                        </li>
                        <li class="flex items-center space-x-2">
                            <i class="fas fa-check text-green-500 text-xs"></i>
                            <span>Add expiry dates for perishable items to track freshness</span>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/admin/inventory/create.blade.php ENDPATH**/ ?>