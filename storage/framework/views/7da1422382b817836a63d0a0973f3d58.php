    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-4xl overflow-hidden">
            ...
            <div class="p-8">
                ...
                <?php $isCorporate = request('corporate') == 1; ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" name="company_name" id="company_name" value="<?php echo e(old('company_name')); ?>" required 
                                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all <?php $__errorArgs = ['company_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="Pasig Catholic College" <?php echo e(old('company') == 'Pasig Catholic College' ? 'selected' : ''); ?>>Pasig Catholic College</option>
                                        <option value="AsiaPro" <?php echo e(old('company') == 'AsiaPro' ? 'selected' : ''); ?>>AsiaPro</option>
                                        <option value="PrimeLime" <?php echo e(old('company') == 'PrimeLime' ? 'selected' : ''); ?>>PrimeLime</option>
                                    </select>
...
</html> <?php /**PATH C:\xampp\htdocs\rss_new\resources\views/auth/register.blade.php ENDPATH**/ ?>