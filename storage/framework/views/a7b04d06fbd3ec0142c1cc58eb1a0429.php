<?php $__env->startSection('title', 'Medical Test Category - ' . $category->name); ?>
<?php $__env->startSection('page-title', 'Medical Test Category'); ?>
<?php $__env->startSection('page-description', 'View category details and associated medical tests'); ?>
...
<div class="space-y-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-white mb-2">
                        <i class="fas fa-flask mr-3"></i><?php echo e($category->name); ?>
                ...
                <div class="flex items-center space-x-4">
                    <div class="bg-blue-800 bg-opacity-50 rounded-lg px-4 py-2 border border-blue-500">
                        ...
                        <p class="text-white text-lg font-bold"><?php echo e($category->medicalTests->count()); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 bg-green-50">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white rounded-lg p-4 border-l-4 border-blue-500">
                    ...
                    <div class="text-lg font-bold text-blue-800"><?php echo e($category->name); ?></div>
                </div>
                <div class="bg-white rounded-lg p-4 border-l-4 border-green-500">
                    <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">Total Tests</label>
                    <div class="text-lg font-bold text-green-800"><?php echo e($category->medicalTests->count()); ?> tests</div>
                </div>
                <div class="bg-white rounded-lg p-4 border-l-4 border-purple-500">
                    ...
                    <div class="text-lg font-bold text-purple-800">
                        <?php echo e($category->medicalTests->count() > 0 ? 'Active' : 'Empty'); ?>
            ...
            <div class="mt-6">
                <div class="bg-white rounded-lg p-4 border border-gray-200">
                    ...
                    <p class="text-gray-700"><?php echo e($category->description); ?></p>
                </div>
            </div>
            <?php endif; ?>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-8">
            <?php if($category->medicalTests->count() > 0): ?>
    ...
    <div class="flex items-center justify-between">
        ...
        <?php if($category->medicalTests->count() > 0): ?>
        <a href="<?php echo e(route('medical-tests.index')); ?>" class="inline-flex items-center px-6 py-3 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
...
<?php echo $__env->make('layouts.doctor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/doctor/medical-test-categories/show.blade.php ENDPATH**/ ?>