<?php $__env->startSection('title', 'Pre-Employment Details - RSS Citi Health Services'); ?>
<?php $__env->startSection('page-title', 'Pre-Employment Details'); ?>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-cyan-100 text-sm">Record ID: #<?php echo e($preEmployment->id); ?></p>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('admin.pre-employment')); ?>" 
        ...
        <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="flex items-center space-x-6 mb-6">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold text-gray-900">
                                <?php echo e($preEmployment->full_name); ?>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e($preEmployment->email ?? 'N/A'); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e($preEmployment->phone_number ?? 'N/A'); ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="space-y-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e($preEmployment->created_at->format('M d, Y')); ?></p>
                                </div>
                            </div>
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900"><?php echo e($preEmployment->company_name ?? 'N/A'); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-card rounded-xl overflow-hidden shadow-lg border border-gray-200">
                ...
                <div class="p-6">
                    ...
                    <?php if($allTests && $allTests->count() > 0): ?>
                        <div class="space-y-4">
                                ...
                                <div class="bg-amber-50 p-4 rounded-lg border border-amber-200">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p class="text-sm text-amber-600 mt-1"><?php echo e($test['test_name']); ?></p>
                                        </div>
                                        <div class="text-right">
                                            <div class="flex items-center space-x-2 text-green-700">
                                                <i class="fas fa-peso-sign text-sm"></i>
                                                <span class="font-semibold"><?php echo e(number_format((float)($test['price'] ?? 0), 2)); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="bg-green-50 p-4 rounded-lg border border-green-200 mt-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-2 text-green-700">
                                        ...
                                        <span class="text-lg font-bold"><?php echo e(number_format((float)($preEmployment->total_price ?? 0), 2)); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500"><?php echo e($preEmployment->created_at->format('M d, Y \a\t g:i A')); ?></p>
                            </div>
                        </div>
                        
                        <?php if($preEmployment->updated_at != $preEmployment->created_at): ?>
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500"><?php echo e($preEmployment->updated_at->format('M d, Y \a\t g:i A')); ?></p>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
        ...
        <div class="p-6">
            <div class="flex items-start space-x-4 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed">
                        Send registration link to <span id="candidateEmail" class="font-medium text-blue-600"><?php echo e($preEmployment->email ?? 'this candidate'); ?></span>? This will allow them to complete their registration process.
                    </p>
                </div>
            </div>
...
<script>
let currentPreEmploymentId = <?php echo e($preEmployment->id); ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/admin/pre-employment-details.blade.php ENDPATH**/ ?>