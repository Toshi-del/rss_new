    ...
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="mt-4 sm:mt-0">
                    <a href="<?php echo e(route('admin.inventory.create')); ?>" 
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900" style="font-family: 'Poppins', sans-serif;"><?php echo e($totalItems); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900" style="font-family: 'Poppins', sans-serif;"><?php echo e($activeItems); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900" style="font-family: 'Poppins', sans-serif;"><?php echo e($lowStockItems); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-900" style="font-family: 'Poppins', sans-serif;"><?php echo e($outOfStockItems); ?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="bg-red-50 border border-red-200 rounded-2xl overflow-hidden">
                    <div class="bg-red-600 px-6 py-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-red-100 text-sm"><?php echo e($criticalItems->count()); ?> <?php echo e(Str::plural('item', $criticalItems->count())); ?> need immediate restocking</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <?php $__currentLoopData = $criticalItems->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-white border-2 border-red-300 rounded-xl p-4 hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1">
                                    <div class="flex items-center justify-between mb-3">
                                        <h4 class="font-bold text-gray-900 text-sm truncate"><?php echo e($item->item_name); ?></h4>
                                    ...
                                    <div class="space-y-2 mb-3">
                                        <div class="flex justify-between text-sm">
                                            ...
                                            <span class="font-bold text-red-600"><?php echo e($item->item_quantity); ?></span>
                                        </div>
                                        <div class="flex justify-between text-sm">
                                            <span class="text-gray-600">Minimum Required:</span>
                                            <span class="font-bold text-gray-900"><?php echo e($item->minimum_stock); ?></span>
                                        </div>
                                        <div class="flex justify-between text-sm">
                                            <span class="text-gray-600">Units Needed:</span>
                                            <span class="font-bold text-red-600"><?php echo e(max(0, $item->minimum_stock - $item->item_quantity)); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        <div class="flex justify-between text-xs text-gray-500 mb-1">
                                            ...
                                            <span><?php echo e($item->minimum_stock > 0 ? round(($item->item_quantity / $item->minimum_stock) * 100) : 0); ?>%</span>
                                        </div>
                                        <div class="w-full bg-gray-200 rounded-full h-3">
                                            <?php
                                                $percentage = $item->minimum_stock > 0 ? min(($item->item_quantity / $item->minimum_stock) * 100, 100) : 0;
                                            ?>
                                            <div class="bg-red-500 h-3 rounded-full transition-all duration-1000 animate-pulse" style="width: <?php echo e($percentage); ?>%"></div>
                                        </div>
                                    </div>
                                    
                                    <div class="flex space-x-2">
                                        <a href="<?php echo e(route('admin.inventory.edit', $item)); ?>" 
                                        ...
                                        <a href="<?php echo e(route('admin.inventory.show', $item)); ?>" 
                        ...
                        <?php if($criticalItems->count() > 6): ?>
                            <div class="mt-4 text-center">
                                <p class="text-red-600 font-medium text-sm">
                                    Showing 6 of <?php echo e($criticalItems->count()); ?> critical items. Scroll down to see all inventory items.
                                </p>
                            </div>
                        <?php endif; ?>
                    </div>
        ...
        <?php if($inventories->count() > 0): ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__currentLoopData = $inventories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl shadow-lg border <?php echo e($item->is_low_stock && $item->item_status === 'active' ? 'border-red-300 ring-2 ring-red-100' : 'border-gray-100'); ?> overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        <!-- Card Header -->
                        <div class="p-6 border-b border-gray-100">
                            <div class="flex items-start justify-between">
                                <div class="flex items-center">
                                    <div class="min-w-0 flex-1">
                                        <div class="item-name text-gray-900 truncate" style="font-family: 'Poppins', sans-serif;"><?php echo e($item->item_name); ?></div>
                                        <?php if($item->category): ?>
                                            <p class="text-xs text-gray-500 mt-1"><?php echo e($item->category); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium <?php echo e($item->status_badge); ?>">
                                    <i class="fas fa-circle mr-1 text-xs"></i>
                                    <?php echo e(ucfirst(str_replace('_', ' ', $item->item_status))); ?>
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                <div class="flex items-center">
                                    <div>
                                        <p class="text-2xl font-bold text-gray-900" style="font-family: 'Poppins', sans-serif;"><?php echo e($item->item_quantity); ?></p>
                                        <p class="text-xs text-gray-500"><?php echo e(Str::plural('unit', $item->item_quantity)); ?></p>
                                    </div>
                                </div>
                                <div class="text-right">
                                    <?php if($item->unit_price): ?>
                                        <p class="text-xs text-gray-500 mb-1">Unit Price</p>
                                        <p class="text-sm font-semibold text-gray-900">₱<?php echo e(number_format($item->unit_price, 2)); ?></p>
                                    <?php else: ?>
                            ...
                            <div class="mb-6">
                                <div class="flex justify-between text-xs text-gray-500 mb-2">
                                    <span>Stock Level</span>
                                    <span>Min: <?php echo e($item->minimum_stock); ?></span>
                                </div>
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    ...
                                    ?>
                                    <div class="<?php echo e($color); ?> h-2 rounded-full transition-all duration-1000" 
                                ...
                                <?php if($item->is_low_stock): ?>
                                    <p class="text-xs text-red-600 mt-1 font-bold animate-pulse">
                                        ...
                                        <?php echo e($item->item_quantity <= $item->minimum_stock ? 'CRITICAL STOCK ALERT' : 'Low Stock Alert'); ?>
                            ...
                            <!-- Additional Info -->
                            <?php if($item->supplier || $item->expiry_date): ?>
                                <div class="mb-4 space-y-1">
                                    ...
                                    <?php if($item->expiry_date): ?>
                                        <div class="flex items-center text-xs text-gray-600">
                                            ...
                                            <span>Expires: <?php echo e($item->expiry_date->format('M d, Y')); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="flex space-x-2">
                                ...
                                <button onclick="openDeleteModal(<?php echo e($item->id); ?>, '<?php echo e($item->item_name); ?>')" 
                                        class="flex-1 inline-flex justify-center items-center px-3 py-2 border border-transparent rounded-lg text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200">
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
                            <div class="flex items-center justify-between text-xs text-gray-500">
                                <div class="flex items-center">
                                    ...
                                    <span>Added <?php echo e($item->created_at->diffForHumans()); ?></span>
                                </div>
                                <div class="flex items-center">
                                    <i class="fas fa-sync-alt mr-1"></i>
                                    <span>Updated <?php echo e($item->updated_at->diffForHumans()); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/admin/inventory/index.blade.php ENDPATH**/ ?>