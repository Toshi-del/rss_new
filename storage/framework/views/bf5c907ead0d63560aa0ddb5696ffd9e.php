            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center px-6 py-3 rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition">
                            Book Appointment
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="service-card bg-white rounded-2xl border border-gray-100 shadow-sm p-8 text-center">
                    ...
                    <a href="<?php echo e(route('register')); ?>?corporate=1" class="inline-flex items-center px-6 py-3 rounded-lg border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white transition">
                        Learn More
    ...
    <section class="py-16 bg-gradient-to-br from-indigo-700 to-blue-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            ...
            <div class="flex justify-center">
                <a href="<?php echo e(route('register')); ?>" class="px-8 py-3 rounded-lg bg-white text-indigo-700 font-semibold hover:bg-blue-50 transition">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-600">
                        ...
                        <li><a href="<?php echo e(route('register')); ?>" class="hover:text-blue-600">Register</a></li>
                            </ul>
                        </div>
                <div>
            ...
            <div class="p-6">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" name="email" id="login-email" value="<?php echo e(old('email')); ?>" required 
                                   class="w-full px-4 py-3 pl-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all <?php $__errorArgs = ['email'];
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="login-password" required 
                                   class="w-full px-4 py-3 pl-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mt-6 text-center">
                    <p class="text-gray-600">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="text-blue-600 hover:text-blue-700 font-semibold transition-colors">
                            Sign up
                        </a>
                    </p>
                </div>
...
<?php /**PATH C:\xampp\htdocs\rss_new\resources\views/services.blade.php ENDPATH**/ ?>