<?php $__env->startSection('title', 'View Inventory Item'); ?>
<?php $__env->startSection('page-title', 'View Inventory Item'); ?>
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900"><?php echo e($inventory->item_name); ?></h1>
                    <p class="text-sm text-gray-600 mt-1">Detailed view of inventory item</p>
                </div>
            </div>
            <div class="flex items-center space-x-3">
                <a href="<?php echo e(route('admin.inventory.edit', $inventory)); ?>" 
                ...
                <button onclick="openDeleteModal(<?php echo e($inventory->id); ?>, '<?php echo e($inventory->item_name); ?>')" 
                    ...
                    <div class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <p class="text-lg font-semibold text-gray-900 mt-1"><?php echo e($inventory->item_name); ?></p>
                            </div>
                            <div>
                                <label class="text-sm font-medium text-gray-500">Category</label>
                                <p class="text-lg font-semibold text-gray-900 mt-1"><?php echo e($inventory->category ?: 'Not specified'); ?></p>
                            </div>
                        </div>
                        ...
                        <?php if($inventory->description): ?>
                            <div>
                                ...
                                <p class="text-gray-900 mt-1 leading-relaxed"><?php echo e($inventory->description); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="text-center">
                                <div class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($inventory->item_quantity); ?></div>
                                <div class="text-sm text-gray-500">Current Stock</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($inventory->minimum_stock); ?></div>
                                <div class="text-sm text-gray-500">Minimum Stock</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold <?php echo e($inventory->is_low_stock ? 'text-red-600' : 'text-green-600'); ?> mb-2">
                                    <?php echo e($inventory->item_quantity - $inventory->minimum_stock); ?>
                        ...
                        <div class="mt-6">
                            <div class="flex justify-between text-sm text-gray-600 mb-2">
                                ...
                                <span><?php echo e($inventory->item_quantity); ?> / <?php echo e($inventory->minimum_stock * 2); ?> (Target)</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-3">
                                ...
                                ?>
                                <div class="<?php echo e($color); ?> h-3 rounded-full transition-all duration-1000" 
                ...
                <?php if($inventory->unit_price): ?>
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-gray-900 mb-2">₱<?php echo e(number_format($inventory->unit_price, 2)); ?></div>
                                    <div class="text-sm text-gray-500">Unit Price</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-gray-900 mb-2">₱<?php echo e(number_format($inventory->unit_price * $inventory->item_quantity, 2)); ?></div>
                                    <div class="text-sm text-gray-500">Total Value</div>
                                </div>
                                <div class="text-center">
                                    <div class="text-2xl font-bold text-gray-900 mb-2">₱<?php echo e(number_format($inventory->unit_price * $inventory->minimum_stock, 2)); ?></div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="flex items-center justify-center">
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium <?php echo e($inventory->status_badge); ?>">
                                <i class="fas fa-circle mr-2 text-xs"></i>
                                <?php echo e(ucfirst(str_replace('_', ' ', $inventory->item_status))); ?>
                        ...
                        <?php if($inventory->expiry_date): ?>
                            <div class="text-center pt-4 border-t border-gray-100">
                                ...
                                <div class="text-lg font-semibold text-gray-900"><?php echo e($inventory->expiry_date->format('M d, Y')); ?></div>
                                <div class="text-xs text-gray-500 mt-1">
                                    <?php echo e($inventory->expiry_date->diffForHumans()); ?>
                    ...
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden">
                        ...
                        <div class="p-6">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <div class="font-semibold text-gray-900"><?php echo e($inventory->supplier); ?></div>
                    ...
                    <div class="p-6 space-y-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <div class="text-xs text-gray-500"><?php echo e($inventory->created_at->format('M d, Y \a\t g:i A')); ?></div>
                                <div class="text-xs text-gray-400"><?php echo e($inventory->created_at->diffForHumans()); ?></div>
                            </div>
                        </div>
                        
                        <?php if($inventory->updated_at != $inventory->created_at): ?>
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-xs text-gray-500"><?php echo e($inventory->updated_at->format('M d, Y \a\t g:i A')); ?></div>
                                    <div class="text-xs text-gray-400"><?php echo e($inventory->updated_at->diffForHumans()); ?></div>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <?php if($inventory->item_status == 'active'): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/admin/inventory/show.blade.php ENDPATH**/ ?>