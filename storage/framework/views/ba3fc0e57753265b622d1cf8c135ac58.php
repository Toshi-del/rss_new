...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('keydown', function(e) {
        ...
        // Escape to cancel
        if (e.key === 'Escape') {
            const cancelButton = document.querySelector('a[href*="annual-physical"], a[href*="pre-employment"]');
            if (cancelButton) {
                cancelButton.click();
            }
        }
...
<?php echo $__env->make('layouts.ecgtech', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new-1\resources\views/ecgtech/medical-checklist-page.blade.php ENDPATH**/ ?>