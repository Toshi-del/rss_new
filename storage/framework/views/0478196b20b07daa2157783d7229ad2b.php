    ...
    <div class="flex h-full">
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-72 sidebar-glass transform -translate-x-full transition-all duration-500 ease-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col custom-scrollbar">
            ...
            <nav class="flex-1 px-4 py-6 space-y-3 overflow-y-auto custom-scrollbar">
                ...
                <a href="<?php echo e(route('admin.medical-test-categories.index')); ?>" class="nav-item flex items-center px-4 py-4 rounded-2xl font-medium <?php echo e(request()->routeIs('admin.medical-test-categories.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('admin.notifications')); ?>" class="nav-item flex items-center px-4 py-4 rounded-2xl font-medium <?php echo e(request()->routeIs('admin.notifications*') ? 'active' : ''); ?>">
    ...
    <div id="notifications-dropdown" class="fixed w-80 bg-white rounded-2xl shadow-2xl border border-gray-200 hidden" style="z-index: 999999;">
        <div class="p-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="<?php echo e(route('admin.notifications')); ?>" class="text-blue-600 hover:text-blue-700 text-sm font-medium">View All</a>
            </div>
        </div>
