...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Radiologist Dashboard - RSS Citi Health Services'); ?></title>
        ...
        <div class="w-72 glass-sidebar relative z-10 shadow-2xl flex flex-col h-full">
            ...
            <nav class="flex-1 px-6 py-8 space-y-2 overflow-y-auto">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="<?php echo e(route('radiologist.dashboard')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('radiologist.dashboard') ? 'active text-white' : ''); ?>">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="<?php echo e(route('radiologist.pre-employment-xray')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('radiologist.pre-employment-xray*') ? 'active text-white' : ''); ?>">
                            <i class="fas fa-briefcase mr-4 text-lg"></i>
                            <span class="font-medium">Pre-Employment X-Ray</span>
                        </a>
                        <a href="<?php echo e(route('radiologist.annual-physical-xray')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('radiologist.annual-physical-xray*') ? 'active text-white' : ''); ?>">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="<?php echo e(route('radiologist.xray-gallery')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('radiologist.xray-gallery*') ? 'active text-white' : ''); ?>">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-gray-900 font-semibold text-sm truncate">
                                <?php echo e(Auth::user()->fname ?? 'Radiologist'); ?> <?php echo e(Auth::user()->lname ?? 'User'); ?>
...
<?php /**PATH C:\xampp\htdocs\rss_new-1\resources\views/layouts/radiologist.blade.php ENDPATH**/ ?>