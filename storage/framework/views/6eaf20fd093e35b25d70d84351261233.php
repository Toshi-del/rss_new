...
<?php $__env->startSection('title', 'Edit Medical Test'); ?>
<?php $__env->startSection('page-title', 'Edit Medical Test'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6">
    <div class="max-w-5xl mx-auto space-y-8">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    <a href="<?php echo e(route('medical-test-categories.show', $medicalTest->medical_test_category_id)); ?>" 
                ...
                <div class="hidden md:flex items-center space-x-2 text-sm text-gray-500">
                    ...
                    <span>Last updated <?php echo e($medicalTest->updated_at->diffForHumans()); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                        <h3 class="text-xl font-bold text-gray-900 mb-2"><?php echo e($medicalTest->name); ?></h3>
                        <div class="flex flex-wrap items-center gap-3">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold <?php echo e($medicalTest->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                <i class="fas fa-<?php echo e($medicalTest->is_active ? 'check-circle' : 'times-circle'); ?> mr-1.5 text-xs"></i>
                                <?php echo e($medicalTest->is_active ? 'Active' : 'Inactive'); ?>

                            </span>
                            <div class="flex items-center space-x-1 text-sm text-gray-600">
                                <i class="fas fa-peso-sign text-gray-400"></i>
                                <span>₱<?php echo e(number_format($medicalTest->price, 2)); ?></span>
                            </div>
                            <div class="flex items-center space-x-1 text-sm text-gray-600">
                                <i class="fas fa-sort-numeric-down text-gray-400"></i>
                                <span>Order: <?php echo e($medicalTest->sort_order); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                <?php if($medicalTest->description): ?>
                    <div class="mt-4 pt-4 border-t border-gray-100">
                        <p class="text-gray-700 leading-relaxed"><?php echo e($medicalTest->description); ?></p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-medium text-gray-900"><?php echo e($medicalTest->category->name ?? 'N/A'); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-600">Created</span>
                        <span class="text-sm font-medium text-gray-900"><?php echo e($medicalTest->created_at->format('M d, Y')); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-600">Last Updated</span>
                        <span class="text-sm font-medium text-gray-900"><?php echo e($medicalTest->updated_at->format('M d, Y')); ?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 overflow-hidden">
            ...
            <form action="<?php echo e(route('medical-tests.update', $medicalTest)); ?>" method="POST" class="p-8 space-y-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-2">
                    ...
                    <select name="medical_test_category_id" id="medical_test_category_id" 
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-150 <?php $__errorArgs = ['medical_test_category_id'];
...
unset($__errorArgs, $__bag); ?>" required>
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category->id); ?>" <?php echo e((old('medical_test_category_id', $medicalTest->medical_test_category_id) == $category->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" 
                           name="name" 
                           id="name" 
                           value="<?php echo e(old('name', $medicalTest->name)); ?>" 
                           placeholder="Enter test name (e.g., Complete Blood Count, Chest X-Ray)"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-150 <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-2 ring-red-200 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="description" 
                              ...
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-150 resize-none <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-2 ring-red-200 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $medicalTest->description)); ?></textarea>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" 
                                   name="price" 
                                   id="price" 
                                   value="<?php echo e(old('price', $medicalTest->price)); ?>" 
                                   step="0.01" 
                                   min="0" 
                                   placeholder="0.00"
                                   class="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-150 <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-2 ring-red-200 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" 
                               name="sort_order" 
                               id="sort_order" 
                               value="<?php echo e(old('sort_order', $medicalTest->sort_order)); ?>" 
                               min="0"
                               placeholder="0"
                               class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-150 <?php $__errorArgs = ['sort_order'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 ring-2 ring-red-200 <?php unset($message);
                    ...
                    <div class="flex items-center space-x-4 mt-3">
                        <label class="inline-flex items-center">
                            <input type="checkbox" 
                                   ...
                                   id="is_active" 
                                   value="1" 
                                   <?php echo e(old('is_active', $medicalTest->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/admin/medical-tests/edit.blade.php ENDPATH**/ ?>