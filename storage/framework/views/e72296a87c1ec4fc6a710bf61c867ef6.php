...
<?php $__env->startSection('page-title', 'Medical Test Categories'); ?>
<?php $__env->startSection('page-description', 'View and manage medical test categories'); ?>
...
<div class="space-y-8">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    <div class="bg-blue-800 bg-opacity-50 rounded-lg px-4 py-2 border border-blue-500">
                        ...
                        <p class="text-white text-lg font-bold"><?php echo e($categories->count()); ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-8">
            <form method="GET" action="<?php echo e(route('medical-test-categories.index')); ?>" class="space-y-4">
                <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <?php if($search): ?>
                        <a href="<?php echo e(route('medical-test-categories.index')); ?>" class="inline-flex items-center px-6 py-3 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors duration-200">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center">
                ...
                <div>
                    <p class="text-sm font-medium text-gray-500"><?php echo e($search ? 'Found Categories' : 'Total Categories'); ?></p>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($categories->sum('medical_tests_count')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-yellow-500 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($categories->where('medical_tests_count', '>', 0)->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500 hover:shadow-xl transition-shadow duration-300">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($categories->currentPage()); ?> of <?php echo e($categories->lastPage()); ?></p>
                </div>
            </div>
        </div>
    </div>
            ...
            <?php if($categories->count() > 0): ?>
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500"><?php echo e($category->medical_tests_count); ?> tests</p>
                                </div>
                            </div>
                        </div>
                        
                        <?php if($category->description): ?>
                        <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e($category->description); ?></p>
                        <?php endif; ?>
                        
                        <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                            <div class="flex items-center space-x-2">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($category->medical_tests_count > 0 ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                                    <i class="fas fa-circle mr-1 text-xs"></i>
                                    <?php echo e($category->medical_tests_count > 0 ? 'Active' : 'Empty'); ?>
                ...
                <div class="mt-8 flex items-center justify-between border-t border-gray-200 pt-6">
                    <div class="flex-1 flex justify-between sm:hidden">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e($categories->previousPageUrl()); ?>" class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                Previous
                            </a>
                        <?php endif; ?>

                        <?php if($categories->hasMorePages()): ?>
                            <a href="<?php echo e($categories->nextPageUrl()); ?>" class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                Next
                            </a>
                        <?php else: ?>
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">
                                Showing <span class="font-medium"><?php echo e($categories->firstItem()); ?></span> to <span class="font-medium"><?php echo e($categories->lastItem()); ?></span> of <span class="font-medium"><?php echo e($categories->total()); ?></span> results
                                <?php if($search): ?>
                        ...
                        <div>
                            <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                ...
                                <?php else: ?>
                                    <a href="<?php echo e($categories->previousPageUrl()); ?>" class="relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                                        <i class="fas fa-chevron-left"></i>
                                    </a>
                                <?php endif; ?>
                                ...
                                <?php if($categories->hasMorePages()): ?>
                                    <a href="<?php echo e($categories->nextPageUrl()); ?>" class="relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    <div class="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fas fa-<?php echo e($search ? 'search' : 'list-alt'); ?> text-gray-400 text-3xl"></i>
                    </div>
                    <h3 class="text-lg font-medium text-gray-900 mb-2">
                        <?php echo e($search ? 'No Categories Found' : 'No Categories Available'); ?>
                    ...
                    <?php if($search): ?>
                        <div class="mt-4">
                            <a href="<?php echo e(route('medical-test-categories.index')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-purple-700 bg-purple-100 hover:bg-purple-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                                <i class="fas fa-times mr-2"></i>
                                Clear Search
                            </a>
                        </div>
...
<?php echo $__env->make('layouts.doctor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new-1\resources\views/doctor/medical-test-categories/index.blade.php ENDPATH**/ ?>