            ...
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <div class="text-center">
                        <div class="text-2xl font-bold text-purple-600"><?php echo e($testData->sum('pre_employment_count')); ?></div>
                        <div class="text-xs text-gray-500">Pre-Employment (90d)</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-blue-600"><?php echo e($testData->sum('total_patients')); ?></div>
                        <div class="text-xs text-gray-500">Total Patients (90d)</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-orange-600"><?php echo e($testData->sum('appointment_count')); ?></div>
                        <div class="text-xs text-gray-500">Appointments (90d)</div>
                    </div>
                    <div class="text-center">
                        <div class="text-2xl font-bold text-green-600">₱<?php echo e(number_format($testData->sum('revenue'), 0)); ?></div>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    <?php $__empty_1 = true; $__currentLoopData = $testData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="hover:bg-gray-50/50 transition-colors duration-150">
                                            <td class="px-6 py-4">
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    <div>
                                                        <div class="text-sm font-medium text-gray-900"><?php echo e($row['test']); ?></div>
                                                        <div class="text-xs text-gray-500">₱<?php echo e(number_format($row['test_price'], 2)); ?> per test</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4">
                                            ...
                                            <td class="px-6 py-4 text-right">
                                                <div class="text-sm font-semibold text-purple-600"><?php echo e($row['pre_employment_count']); ?></div>
                                                <div class="text-xs text-gray-500">₱<?php echo e(number_format($row['per_revenue'], 2)); ?></div>
                                            </td>
                                            <td class="px-6 py-4 text-right">
                                                <div class="text-sm font-semibold text-blue-600"><?php echo e($row['total_patients']); ?></div>
                                                <div class="text-xs text-gray-500"><?php echo e($row['appointment_count']); ?> appointments</div>
                                                <div class="text-xs text-gray-500">₱<?php echo e(number_format($row['appt_revenue'], 2)); ?></div>
                                            </td>
                                            <td class="px-6 py-4 text-right">
                                                <div class="text-sm font-semibold text-green-600">₱<?php echo e(number_format($row['revenue'], 2)); ?></div>
                                                <div class="text-xs text-gray-500"><?php echo e($row['count']); ?> total tests</div>
                                            </td>
                                        </tr>
...
<script>
    (function(){
        ...
        const testCounts = <?php echo json_encode($monthlyTestCounts, 15, 512) ?>;
        const revenue = <?php echo json_encode($monthlyRevenue, 15, 512) ?>;
        const topCatLabels = <?php echo json_encode($categoryData->pluck('name'), 15, 512) ?>;
        const topCatCounts = <?php echo json_encode($categoryData->pluck('count'), 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/admin/report.blade.php ENDPATH**/ ?>