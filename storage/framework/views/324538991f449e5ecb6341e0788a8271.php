<?php $__env->startSection('title', 'OPD Blood Collection'); ?>
<?php $__env->startSection('page-title', 'OPD Walk-in Records'); ?>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="content-card rounded-2xl p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-blue-500">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h3 class="text-2xl font-bold text-gray-900"><?php echo e($opdPatients->total()); ?></h3>
    ...
    <div class="content-card rounded-2xl p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-green-500">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                ?>
                <h3 class="text-2xl font-bold text-gray-900"><?php echo e($completedCount); ?></h3>
    ...
    <div class="content-card rounded-2xl p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-yellow-500">
        <div class="flex items-center space-x-4">
            ...
            <div>
                ...
                ?>
                <h3 class="text-2xl font-bold text-gray-900"><?php echo e($pendingCount); ?></h3>
    ...
    <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
        <div class="flex items-center justify-between">
            ...
            <div class="bg-white/20 px-3 py-1 rounded-full">
                <span class="text-white font-semibold"><?php echo e($opdPatients->count()); ?> Patients</span>
            </div>
        </div>
    </div>
                    ...
                    <tr class="hover:bg-blue-50/50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                ...
                                <!-- Generate Barcode -->
                                <button onclick="generateBarcode(<?php echo e($patient->id); ?>)" 
...
<?php echo $__env->make('layouts.plebo', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/plebo/opd.blade.php ENDPATH**/ ?>