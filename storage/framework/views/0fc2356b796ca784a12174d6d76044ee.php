...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Phlebotomy Portal'); ?> - RSS Health Services Corp</title>
    ...
    <div class="flex h-full">
        ...
        <div id="sidebar" class="fixed inset-y-0 left-0 z-50 w-72 sidebar-glass transform -translate-x-full transition-all duration-500 ease-out lg:translate-x-0 lg:static lg:inset-0 flex flex-col custom-scrollbar">
            ...
            <nav class="flex-1 px-4 py-6 space-y-3 overflow-y-auto custom-scrollbar">
                ...
                <a href="<?php echo e(route('plebo.dashboard')); ?>" class="nav-item flex items-center px-4 py-4 rounded-2xl font-medium <?php echo e(request()->routeIs('plebo.dashboard') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('plebo.pre-employment')); ?>" class="nav-item flex items-center px-4 py-4 rounded-2xl font-medium <?php echo e(request()->routeIs('plebo.pre-employment') ? 'active' : ''); ?>">
                    <i class="fas fa-user-md text-lg mr-4"></i>
                    <span>Pre-Employment</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-60"></i>
                </a>
                
                <a href="<?php echo e(route('plebo.annual-physical')); ?>" class="nav-item flex items-center px-4 py-4 rounded-2xl font-medium <?php echo e(request()->routeIs('plebo.annual-physical') ? 'active' : ''); ?>">
                    <i class="fas fa-file-medical text-lg mr-4"></i>
                    <span>Annual Physical</span>
                    <i class="fas fa-chevron-right ml-auto text-xs opacity-60"></i>
                </a>
                
                <a href="<?php echo e(route('plebo.opd')); ?>" class="nav-item flex items-center px-4 py-4 rounded-2xl font-medium <?php echo e(request()->routeIs('plebo.opd') ? 'active' : ''); ?>">
                ...
                <div class="bg-gray-50 rounded-2xl p-4 border border-gray-200">
                    <div class="flex items-center space-x-3">
                        <div class="w-12 h-12 rounded-2xl bg-orange-600 flex items-center justify-center text-white font-bold text-lg">
                            <?php echo e(substr(Auth::user()->fname ?? 'P', 0, 1)); ?>

                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-gray-900 font-semibold text-sm truncate">
                                <?php echo e(Auth::user()->fname ?? 'Phlebotomist'); ?> <?php echo e(Auth::user()->lname ?? 'User'); ?>
                ...
                <div class="flex items-center justify-between px-6 py-5">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600 text-sm font-medium">Welcome back, <?php echo e(Auth::user()->fname ?? 'Phlebotomist'); ?>!</p>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\rss_new-1\resources\views/layouts/plebo.blade.php ENDPATH**/ ?>