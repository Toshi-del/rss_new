<?php $__env->startSection('title', 'OPD Walk-in Patients'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
        <form method="GET" action="<?php echo e(route('pathologist.opd')); ?>" class="flex flex-wrap items-center gap-4">
            ...
            <?php if(request()->hasAny(['search'])): ?>
                <a href="<?php echo e(route('pathologist.opd')); ?>" class="bg-gradient-to-r from-gray-500 to-gray-600 text-white px-6 py-2 rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-gray-600">
                    Total: <?php echo e($opdPatients->total()); ?> patients
                </div>
            </div>
        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $opdPatients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                <?php echo e($patient->fname); ?> <?php echo e($patient->lname); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($patient->phone); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($patient->created_at->format('M d, Y')); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php
                                    ...
                                    $medicalChecklist = \App\Models\MedicalChecklist::where('user_id', $patient->id)
                                        ...
                                        ->first();
                                ?>
                                <?php if($opdExam && $opdExam->lab_report && !empty(array_filter($opdExam->lab_report))): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <!-- Edit Lab Results -->
                                    <a href="<?php echo e(route('pathologist.opd.edit', $patient->id)); ?>" class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded-full transition-all duration-200 flex items-center text-sm font-medium shadow-sm hover:shadow-md" title="Edit Lab Results">
                                    ...
                                    <!-- Medical Checklist -->
                                    <a href="<?php echo e(route('pathologist.medical-checklist.opd', $patient->id)); ?>" class="bg-purple-500 hover:bg-purple-600 text-white px-3 py-2 rounded-full transition-all duration-200 flex items-center text-sm font-medium shadow-sm hover:shadow-md" title="Medical Checklist">
        ...
        <?php if($opdPatients->hasPages()): ?>
            <div class="px-6 py-4 border-t border-gray-200">
                <?php echo e($opdPatients->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('layouts.pathologist', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/pathologist/opd.blade.php ENDPATH**/ ?>