        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex items-center space-x-2">
                    <a href="<?php echo e(route('patient.dashboard')); ?>" class="nav-item px-4 py-2 text-gray-700">
                        <i class="fas fa-th-large mr-2"></i>
                        <span class="font-medium">Dashboard</span>
                    </a>
                    <a href="<?php echo e(route('patient.profile')); ?>" class="nav-item px-4 py-2 text-gray-700 active">
        ...
        <div class="content-card profile-gradient rounded-2xl p-8 mb-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold mb-2 text-white"><?php echo e(Auth::user()->fname); ?> <?php echo e(Auth::user()->lname); ?></h1>
                ...
                <div class="text-right bg-white/10 rounded-2xl p-4">
                    ...
                    <p class="text-2xl font-bold text-white"><?php echo e(Auth::user()->created_at->format('Y')); ?></p>
                    <p class="text-white/80 text-sm"><?php echo e(Auth::user()->created_at->format('M d')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div class="content-card rounded-2xl p-8">
                    ...
                    <form method="POST" action="<?php echo e(route('patient.profile.update')); ?>" class="space-y-8">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2 md:col-span-2">
                                    ...
                                    <input type="text" name="mname" value="<?php echo e(Auth::user()->mname); ?>" 
                                           class="form-input w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="tel" name="phone" value="<?php echo e(Auth::user()->phone); ?>" 
                                           class="form-input w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="text" name="company" value="<?php echo e(Auth::user()->company); ?>" 
                                       class="form-input w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
                ...
                <div class="content-card rounded-2xl p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                            ...
                            <span class="text-sm font-semibold text-gray-800"><?php echo e(Auth::user()->created_at->format('M Y')); ?></span>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                            ...
                            <span class="text-sm font-semibold text-indigo-600"><?php echo e(ucfirst(Auth::user()->role)); ?></span>
                        </div>
...
</html> <?php /**PATH C:\xampp\htdocs\rss_new\resources\views/patient/profile.blade.php ENDPATH**/ ?>