<?php $__env->startSection('title', 'Edit Pre-Employment Medical Examination - RSS Citi Health Services'); ?>
<?php $__env->startSection('page-title', 'Edit Pre-Employment Examination'); ?>
<?php $__env->startSection('page-description', 'Update employment medical screening and health assessment'); ?>
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="text-right">
                    ...
                    <div class="text-white font-bold text-lg">#<?php echo e($preEmployment->id); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content-card rounded-xl p-8 shadow-lg border border-gray-200">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="flex items-center space-x-3">
                    <div class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
                        <span class="text-blue-600 font-semibold text-sm">
                            <?php echo e(substr($preEmployment->preEmploymentRecord->first_name ?? 'C', 0, 1)); ?><?php echo e(substr($preEmployment->preEmploymentRecord->last_name ?? 'A', 0, 1)); ?>
            ...
            <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                ...
                <div class="text-lg font-semibold text-gray-900"><?php echo e($preEmployment->preEmploymentRecord->age); ?> years old</div>
            </div>
            <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                <label class="block text-xs font-semibold text-gray-600 uppercase mb-2">Gender</label>
                <div class="text-lg font-semibold text-gray-900"><?php echo e(ucfirst($preEmployment->preEmploymentRecord->sex)); ?></div>
            </div>
            <div class="bg-gray-50 rounded-xl p-4 border border-gray-100">
                <label class="block text-xs font-semibold text-gray-600 uppercase mb-2">Company</label>
                <div class="text-sm font-medium text-gray-900"><?php echo e($preEmployment->preEmploymentRecord->company_name); ?></div>
            </div>
        </div>
    </div>
    <?php endif; ?>
    <!-- Edit Form -->
    <form action="<?php echo e(route('nurse.pre-employment.update', $preEmployment->id)); ?>" method="POST" class="space-y-8">
        <?php echo csrf_field(); ?>
        ...
        <div class="content-card rounded-xl p-8 shadow-lg border border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php $phys = old('physical_exam', $preEmployment->physical_exam ?? []); ?>
        ...
        <div class="content-card rounded-xl p-8 shadow-lg border border-gray-200">
            ...
            <div class="space-y-2">
                ...
                <textarea name="skin_marks" rows="4" 
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                          placeholder="Describe any visible skin marks, scars, tattoos, or identifying features..."><?php echo e(old('skin_marks', $preEmployment->skin_marks)); ?></textarea>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <textarea name="visual" rows="4" 
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                              placeholder="Record visual acuity test results (e.g., 20/20, corrected/uncorrected vision)"><?php echo e(old('visual', $preEmployment->visual)); ?></textarea>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="ishihara_test" rows="4" 
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                              placeholder="Record color vision test results (e.g., Normal, Color blind - specify type)"><?php echo e(old('ishihara_test', $preEmployment->ishihara_test)); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="content-card rounded-xl p-8 shadow-lg border border-gray-200">
            ...
            <div class="space-y-2">
                ...
                <textarea name="findings" rows="5" 
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                          placeholder="Record overall medical findings, any abnormalities, recommendations, or fitness for employment assessment..."><?php echo e(old('findings', $preEmployment->findings)); ?></textarea>
            </div>
        </div>
        ...
        <div class="content-card rounded-xl p-8 shadow-lg border border-gray-200">
            <div class="flex items-center space-x-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Examination updated by: <?php echo e(Auth::user()->fname); ?> <?php echo e(Auth::user()->lname); ?></p>
                </div>
            </div>
...
<?php echo $__env->make('layouts.nurse', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new-1\resources\views/nurse/pre-employment-edit.blade.php ENDPATH**/ ?>