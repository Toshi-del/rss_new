...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Company Portal'); ?> - RSS Citi Health Services</title>
        ...
        <div id="sidebar" class="w-72 glass-sidebar relative z-10 shadow-2xl flex flex-col h-full">
            ...
            <nav class="flex-1 px-6 py-8 space-y-2 overflow-y-auto">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="<?php echo e(route('company.dashboard')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('company.dashboard') ? 'active text-white' : ''); ?>">
                            <i class="fas fa-chart-line mr-4 text-lg"></i>
                            <span class="font-medium">Dashboard</span>
                        </a>
                        <a href="<?php echo e(route('company.appointments.index')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('company.appointments.*') ? 'active text-white' : ''); ?>">
                        ...
                        <a href="<?php echo e(route('company.pre-employment.index')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('company.pre-employment.*') ? 'active text-white' : ''); ?>">
                            <i class="fas fa-briefcase mr-4 text-lg"></i>
                            <span class="font-medium">Pre-Employment</span>
                        </a>
                        <a href="<?php echo e(route('company.medical-results')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('company.medical-results*') ? 'active text-white' : ''); ?>">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="<?php echo e(route('company.account-invitations.index')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('company.account-invitations*') ? 'active text-white' : ''); ?>">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-1">
                        <a href="<?php echo e(route('company.messages')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('company.messages') ? 'active text-white' : ''); ?>">
                            <i class="fas fa-comments mr-4 text-lg"></i>
                            <span class="font-medium">Messages</span>
                            <span class="ml-auto bg-red-500 text-white text-xs px-2 py-1 rounded-full">3</span>
                        </a>
                        <a href="<?php echo e(route('company.settings')); ?>" class="nav-item flex items-center px-4 py-3 text-gray-700 hover:text-gray-900 rounded-xl transition-all duration-200 <?php echo e(request()->routeIs('company.settings*') ? 'active text-white' : ''); ?>">
                ...
                <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                    <div class="flex items-center space-x-3">
                        <div class="w-12 h-12 rounded-xl bg-blue-600 flex items-center justify-center text-white font-bold text-lg shadow-lg">
                            <?php echo e(substr(Auth::user()->full_name ?? 'C', 0, 1)); ?>

                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-gray-900 font-semibold text-sm truncate">
                                <?php echo e(Auth::user()->full_name ?? 'Company Admin'); ?>
            ...
            <header class="content-card shadow-lg border-b border-gray-200 relative z-20">
                <div class="flex items-center justify-between px-8 py-6">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900"><?php echo $__env->yieldContent('page-title', 'Company Dashboard'); ?></h1>
                            <p class="text-sm text-gray-600 mt-1"><?php echo $__env->yieldContent('page-description', 'Manage your company\'s medical examinations and employee health records'); ?></p>
                        </div>
                    </div>
        ...
        <div class="relative mx-auto p-0 border-0 w-full max-w-md shadow-2xl rounded-2xl bg-white">
            ...
            <div class="p-8">
                ...
                <div class="flex items-center space-x-4 mb-8 p-4 bg-blue-50 rounded-xl border border-blue-100">
                    ...
                    <div class="flex-1">
                        <h4 class="text-lg font-bold text-gray-900"><?php echo e(Auth::user()->full_name ?? 'Company Admin'); ?></h4>
                        <p class="text-sm text-gray-600"><?php echo e(Auth::user()->email ?? 'admin@company.com'); ?></p>
...
</html> <?php /**PATH C:\xampp\htdocs\rss_new-1\resources\views/layouts/company.blade.php ENDPATH**/ ?>