<?php $__env->startSection('title', 'Create Account Invitation'); ?>
...
<div class="min-h-screen" style="font-family: 'Poppins', sans-serif;">
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="px-8 py-6 bg-gradient-to-r from-blue-600 to-blue-700">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <a href="<?php echo e(route('company.account-invitations.index')); ?>" 
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <form action="<?php echo e(route('company.account-invitations.store')); ?>" method="POST" class="p-8">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="md:col-span-2">
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                                ...
                                <label class="relative cursor-pointer">
                                    <input type="radio" name="expiration_hours" value="<?php echo e($option['value']); ?>" 
                                           class="sr-only peer" <?php echo e(old('expiration_hours') == $option['value'] ? 'checked' : ''); ?>>
                                    <div class="p-4 border-2 border-gray-200 rounded-lg hover:border-indigo-300 peer-checked:border-indigo-600 peer-checked:bg-indigo-50 transition-all duration-200">
                                        <div class="flex items-center justify-center mb-2">
                                            <i class="fas <?php echo e($option['icon']); ?> text-2xl text-indigo-600"></i>
                                        </div>
                                        <h3 class="text-sm font-bold text-gray-900 text-center"><?php echo e($option['label']); ?></h3>
                                        <p class="text-xs text-gray-600 text-center mt-1"><?php echo e($option['desc']); ?></p>
                                    </div>
                                </label>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 border-l-4 border-gray-400">
                            ...
                            <select id="expiration_hours_custom" 
                                ...
                                <option value="2" <?php echo e(old('expiration_hours') == '2' ? 'selected' : ''); ?>>2 hours</option>
                                <option value="6" <?php echo e(old('expiration_hours') == '6' ? 'selected' : ''); ?>>6 hours</option>
                                <option value="48" <?php echo e(old('expiration_hours') == '48' ? 'selected' : ''); ?>>2 days</option>
                                <option value="120" <?php echo e(old('expiration_hours') == '120' ? 'selected' : ''); ?>>5 days</option>
                            </select>
                        </div>
                    </div>
                    
                    <?php $__errorArgs = ['expiration_hours'];
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/company/account-invitations/create.blade.php ENDPATH**/ ?>