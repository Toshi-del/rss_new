<?php $__env->startSection('title', 'ECG Medical Checklist'); ?>

<?php $__env->startSection('page-title', 'ECG Medical Checklist'); ?>
<?php $__env->startSection('page-description', 'Complete cardiac examination checklist and ECG assessment'); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <div class="p-8">
            <?php if($medicalChecklist): ?>
                ...
                <form action="<?php echo e(route('ecgtech.medical-checklist.update', $medicalChecklist->id)); ?>" method="POST" class="space-y-8">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PATCH'); ?>
            <?php else: ?>
                <!-- Create new checklist -->
                <form action="<?php echo e(route('ecgtech.medical-checklist.store')); ?>" method="POST" class="space-y-8">
                    <?php echo csrf_field(); ?>
            <?php endif; ?>
                
                <input type="hidden" name="examination_type" value="<?php echo e($examinationType); ?>">
                <?php if($examinationType === 'annual-physical'): ?>
                    <input type="hidden" name="patient_id" value="<?php echo e($patient->id); ?>">
                <?php elseif($examinationType === 'pre-employment'): ?>
                    <input type="hidden" name="pre_employment_record_id" value="<?php echo e($record->id); ?>">
                <?php elseif($examinationType === 'opd'): ?>
                    <input type="hidden" name="opd_examination_id" value="<?php echo e($opdExamination->id ?? 0); ?>">
                <?php endif; ?>
                ...
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <div class="text-lg font-semibold text-gray-900"><?php echo e($name); ?></div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <div class="text-lg font-semibold text-gray-900"><?php echo e($date); ?></div>
                            <input type="hidden" name="date" value="<?php echo e($date); ?>" />
                        </div>
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Age</label>
                            <div class="text-lg font-semibold text-gray-900"><?php echo e($age); ?> years</div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200">
                            ...
                            <div class="text-lg font-semibold text-gray-900"><?php echo e($number ?? 'N/A'); ?></div>
                        ...
                        <?php $__currentLoopData = [
                            ...
                            <div class="bg-gray-50 rounded-lg p-4 border border-gray-200 hover:bg-gray-100 transition-colors duration-200">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4">
                                        <div class="w-8 h-8 bg-<?php echo e($exam['color']); ?>-100 rounded-lg flex items-center justify-center">
                                            <i class="<?php echo e($exam['icon']); ?> text-<?php echo e($exam['color']); ?>-600 text-sm"></i>
                                        </div>
                                        <div>
                                            <div class="flex items-center space-x-2">
                                                <span class="text-sm font-bold text-gray-600"><?php echo e($loop->iteration); ?>.</span>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <?php if($field === 'ecg'): ?>
                                            ...
                                            <input type="text" name="<?php echo e($field); ?>_done_by" 
                                                   value="<?php echo e(old($field . '_done_by', $medicalChecklist->{$field . '_done_by'} ?? Auth::user()->fname . ' ' . Auth::user()->lname)); ?>" 
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-200">
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                        ...
                        <input type="text" name="optional_exam" 
                               value="<?php echo e(old('optional_exam', $medicalChecklist->optional_exam ?? 'Audiometry/Ishihara')); ?>" 
                ...
                <div class="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 sm:space-x-4 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex space-x-4">
                        <?php if($examinationType === 'opd'): ?>
                            <a href="<?php echo e(route('ecgtech.opd')); ?>" 
                        ...
                        <?php elseif($examinationType === 'annual-physical'): ?>
                            <a href="<?php echo e(route('ecgtech.annual-physical')); ?>" 
                               class="inline-flex items-center px-6 py-3 border border-gray-300 rounded-xl text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200 font-semibold">
                                <i class="fas fa-arrow-left mr-2"></i>
                                Back to Annual Physical
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('ecgtech.dashboard')); ?>" 
                               class="inline-flex items-center px-6 py-3 border border-gray-300 rounded-xl text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200 font-semibold">
                                <i class="fas fa-arrow-left mr-2"></i>
                                Back to Dashboard
                            </a>
                        ...
                        <button type="submit" 
                            ...
                            <?php echo e($medicalChecklist ? 'Update' : 'Submit'); ?> ECG Report
                        </button>
                    </div>
                </div>
            </form>
...
<?php echo $__env->make('layouts.ecgtech', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/ecgtech/medical-checklist.blade.php ENDPATH**/ ?>