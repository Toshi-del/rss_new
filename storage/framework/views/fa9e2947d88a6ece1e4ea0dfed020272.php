<?php $__env->startSection('title', 'Edit Reference Ranges - ' . $test->name); ?>
<?php $__env->startSection('page-title', 'Edit Reference Ranges'); ?>
<?php $__env->startSection('page-description', 'Update reference ranges for medical test'); ?>
...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-4">
                    <div class="bg-blue-800 bg-opacity-50 rounded-lg px-4 py-2 border border-blue-500">
                        ...
                        <p class="text-white text-lg font-bold">#<?php echo e($test->id); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="p-8 bg-green-50">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="bg-white rounded-lg p-6 border-l-4 border-blue-500 shadow-sm hover:shadow-md transition-shadow duration-200">
                    ...
                    <div class="text-lg font-bold text-blue-800"><?php echo e($test->name); ?></div>
                </div>
                <div class="bg-white rounded-lg p-6 border-l-4 border-green-500 shadow-sm hover:shadow-md transition-shadow duration-200">
                    ...
                    <div class="text-lg font-bold text-green-800"><?php echo e($test->category->name ?? 'No Category'); ?></div>
                </div>
                <div class="bg-white rounded-lg p-6 border-l-4 border-yellow-500 shadow-sm hover:shadow-md transition-shadow duration-200">
                    ...
                    <div class="text-lg font-bold text-yellow-800">₱<?php echo e(number_format($test->price, 2)); ?></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="p-8">
            <form action="<?php echo e(route('medical-tests.update', $test->id)); ?>" method="POST" class="space-y-8">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        ...
                        <div>
                            ...
                            <div class="w-full px-4 py-3 border border-gray-200 rounded-lg bg-white text-gray-700 min-h-[100px] shadow-sm">
                                <?php echo e($test->description ?: 'No description provided'); ?>
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                    ...
                    <div id="referenceRangesContainer" class="space-y-4">
                        <?php if($test->referenceRanges->count() > 0): ?>
                            <?php $__currentLoopData = $test->referenceRanges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $range): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="reference-range-item bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200">
                                <div class="flex items-center justify-between mb-4">
                                    <h4 class="text-sm font-semibold text-gray-800 flex items-center">
                                        ...
                                        Reference Range #<?php echo e($index + 1); ?>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="reference_ranges[<?php echo e($index); ?>][reference_name]" 
                                               value="<?php echo e(old('reference_ranges.'.$index.'.reference_name', $range->reference_name)); ?>"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="reference_ranges[<?php echo e($index); ?>][reference_range]" 
                                               value="<?php echo e(old('reference_ranges.'.$index.'.reference_range', $range->reference_range)); ?>"
                                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-sm"
                ...
                <div class="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('medical-test-categories.show', $test->category->id)); ?>" 
...
document.addEventListener('DOMContentLoaded', function() {
    let referenceRangeIndex = <?php echo e($test->referenceRanges->count()); ?>;
...
<?php echo $__env->make('layouts.doctor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/doctor/medical-tests/edit.blade.php ENDPATH**/ ?>