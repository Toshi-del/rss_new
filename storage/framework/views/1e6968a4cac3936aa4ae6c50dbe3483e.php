                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="url" name="website" id="website" 
                                           value="<?php echo e(auth()->user()->website ?? ''); ?>"
                                           class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                <div>
                                    ...
                                    <select name="industry" id="industry" 
                                        ...
                                        <option value="healthcare" <?php echo e(auth()->user()->industry == 'healthcare' ? 'selected' : ''); ?>>Healthcare</option>
                                        <option value="manufacturing" <?php echo e(auth()->user()->industry == 'manufacturing' ? 'selected' : ''); ?>>Manufacturing</option>
                                        <option value="technology" <?php echo e(auth()->user()->industry == 'technology' ? 'selected' : ''); ?>>Technology</option>
                                        <option value="finance" <?php echo e(auth()->user()->industry == 'finance' ? 'selected' : ''); ?>>Finance</option>
                                        <option value="retail" <?php echo e(auth()->user()->industry == 'retail' ? 'selected' : ''); ?>>Retail</option>
                                        <option value="construction" <?php echo e(auth()->user()->industry == 'construction' ? 'selected' : ''); ?>>Construction</option>
                                        <option value="other" <?php echo e(auth()->user()->industry == 'other' ? 'selected' : ''); ?>>Other</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <select name="employee_count" id="employee_count" 
                                        ...
                                        <option value="1-10" <?php echo e(auth()->user()->employee_count == '1-10' ? 'selected' : ''); ?>>1-10</option>
                                        <option value="11-50" <?php echo e(auth()->user()->employee_count == '11-50' ? 'selected' : ''); ?>>11-50</option>
                                        <option value="51-200" <?php echo e(auth()->user()->employee_count == '51-200' ? 'selected' : ''); ?>>51-200</option>
                                        <option value="201-500" <?php echo e(auth()->user()->employee_count == '201-500' ? 'selected' : ''); ?>>201-500</option>
                                        <option value="500+" <?php echo e(auth()->user()->employee_count == '500+' ? 'selected' : ''); ?>>500+</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.company', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rss_new\resources\views/company/settings.blade.php ENDPATH**/ ?>